...
public class HostPortGroup  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private java.lang.String key;

    private com.vmware.converter.HostPortGroupPort[] port;

    private java.lang.String vswitch;

    private com.vmware.converter.HostNetworkPolicy computedPolicy;

    private com.vmware.converter.HostPortGroupSpec spec;
    ...
    public HostPortGroup(
           ...
           com.vmware.converter.HostPortGroupPort[] port,
           java.lang.String vswitch,
           com.vmware.converter.HostNetworkPolicy computedPolicy,
           com.vmware.converter.HostPortGroupSpec spec) {
        this.key = key;
        this.port = port;
     ...
     * @return port
     */
    public com.vmware.converter.HostPortGroupPort[] getPort() {
        return port;
    }
     ...
     * @param port
     */
    public void setPort(com.vmware.converter.HostPortGroupPort[] port) {
        this.port = port;
    }

    public com.vmware.converter.HostPortGroupPort getPort(int i) {
        return this.port[i];
    }

    public void setPort(int i, com.vmware.converter.HostPortGroupPort _value) {
        this.port[i] = _value;
    }
     ...
     */
    public com.vmware.converter.HostNetworkPolicy getComputedPolicy() {
        return computedPolicy;
    }
     ...
     */
    public void setComputedPolicy(com.vmware.converter.HostNetworkPolicy computedPolicy) {
        this.computedPolicy = computedPolicy;
    }
     ...
     * @return spec
     */
    public com.vmware.converter.HostPortGroupSpec getSpec() {
        return spec;
    }
     ...
     * @param spec
     */
    public void setSpec(com.vmware.converter.HostPortGroupSpec spec) {
        this.spec = spec;
    }
