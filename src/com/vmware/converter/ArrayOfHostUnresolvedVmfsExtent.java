...
public class ArrayOfHostUnresolvedVmfsExtent  implements java.io.Serializable {
    private com.vmware.converter.HostUnresolvedVmfsExtent[] hostUnresolvedVmfsExtent;

    public ArrayOfHostUnresolvedVmfsExtent() {
    }

    public ArrayOfHostUnresolvedVmfsExtent(
           com.vmware.converter.HostUnresolvedVmfsExtent[] hostUnresolvedVmfsExtent) {
     ...
     */
    public com.vmware.converter.HostUnresolvedVmfsExtent[] getHostUnresolvedVmfsExtent() {
        return hostUnresolvedVmfsExtent;
    }
     ...
     */
    public void setHostUnresolvedVmfsExtent(com.vmware.converter.HostUnresolvedVmfsExtent[] hostUnresolvedVmfsExtent) {
        this.hostUnresolvedVmfsExtent = hostUnresolvedVmfsExtent;
    }

    public com.vmware.converter.HostUnresolvedVmfsExtent getHostUnresolvedVmfsExtent(int i) {
        return this.hostUnresolvedVmfsExtent[i];
    }

    public void setHostUnresolvedVmfsExtent(int i, com.vmware.converter.HostUnresolvedVmfsExtent _value) {
