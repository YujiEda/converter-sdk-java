...
public class ClusterPowerOnVmResult  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ClusterAttemptedVmInfo[] attempted;

    private com.vmware.converter.ClusterNotAttemptedVmInfo[] notAttempted;
    ...
    public ClusterPowerOnVmResult(
           com.vmware.converter.ClusterAttemptedVmInfo[] attempted,
           com.vmware.converter.ClusterNotAttemptedVmInfo[] notAttempted,
     ...
     * @return attempted
     */
    public com.vmware.converter.ClusterAttemptedVmInfo[] getAttempted() {
        return attempted;
    }
     ...
     * @param attempted
     */
    public void setAttempted(com.vmware.converter.ClusterAttemptedVmInfo[] attempted) {
        this.attempted = attempted;
    }

    public com.vmware.converter.ClusterAttemptedVmInfo getAttempted(int i) {
        return this.attempted[i];
    }

    public void setAttempted(int i, com.vmware.converter.ClusterAttemptedVmInfo _value) {
     ...
     * @return notAttempted
     */
    public com.vmware.converter.ClusterNotAttemptedVmInfo[] getNotAttempted() {
        return notAttempted;
    }
     ...
     * @param notAttempted
     */
    public void setNotAttempted(com.vmware.converter.ClusterNotAttemptedVmInfo[] notAttempted) {
        this.notAttempted = notAttempted;
    }

    public com.vmware.converter.ClusterNotAttemptedVmInfo getNotAttempted(int i) {
        return this.notAttempted[i];
    }

    public void setNotAttempted(int i, com.vmware.converter.ClusterNotAttemptedVmInfo _value) {
