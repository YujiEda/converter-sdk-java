...
public class HostUnresolvedVmfsVolume  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostUnresolvedVmfsExtent[] extent;
    ...
    private com.vmware.converter.HostUnresolvedVmfsVolumeResolveStatus resolveStatus;

    public HostUnresolvedVmfsVolume() {
    }

    public HostUnresolvedVmfsVolume(
           com.vmware.converter.HostUnresolvedVmfsExtent[] extent,
           java.lang.String vmfsLabel,
           java.lang.String vmfsUuid,
           int totalBlocks,
           com.vmware.converter.HostUnresolvedVmfsVolumeResolveStatus resolveStatus) {
        this.extent = extent;
     ...
     * @return extent
     */
    public com.vmware.converter.HostUnresolvedVmfsExtent[] getExtent() {
        return extent;
    }
     ...
     * @param extent
     */
    public void setExtent(com.vmware.converter.HostUnresolvedVmfsExtent[] extent) {
        this.extent = extent;
    }

    public com.vmware.converter.HostUnresolvedVmfsExtent getExtent(int i) {
        return this.extent[i];
    }

    public void setExtent(int i, com.vmware.converter.HostUnresolvedVmfsExtent _value) {
     ...
     */
    public com.vmware.converter.HostUnresolvedVmfsVolumeResolveStatus getResolveStatus() {
        return resolveStatus;
    }
     ...
     * @param resolveStatus
     */
    public void setResolveStatus(com.vmware.converter.HostUnresolvedVmfsVolumeResolveStatus resolveStatus) {
        this.resolveStatus = resolveStatus;
    }
