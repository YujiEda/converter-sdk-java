...
public class ArrayOfHostIpRouteOp  implements java.io.Serializable {
    private com.vmware.converter.HostIpRouteOp[] hostIpRouteOp;

    public ArrayOfHostIpRouteOp() {
    }

    public ArrayOfHostIpRouteOp(
           com.vmware.converter.HostIpRouteOp[] hostIpRouteOp) {
     ...
     */
    public com.vmware.converter.HostIpRouteOp[] getHostIpRouteOp() {
        return hostIpRouteOp;
    }
     ...
     * @param hostIpRouteOp
     */
    public void setHostIpRouteOp(com.vmware.converter.HostIpRouteOp[] hostIpRouteOp) {
        this.hostIpRouteOp = hostIpRouteOp;
    }

    public com.vmware.converter.HostIpRouteOp getHostIpRouteOp(int i) {
        return this.hostIpRouteOp[i];
    }

    public void setHostIpRouteOp(int i, com.vmware.converter.HostIpRouteOp _value) {
