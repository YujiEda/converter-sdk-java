...
public class ArrayOfHostPlugStoreTopologyAdapter  implements java.io.Serializable {
    private com.vmware.converter.HostPlugStoreTopologyAdapter[] hostPlugStoreTopologyAdapter;

    public ArrayOfHostPlugStoreTopologyAdapter() {
    }

    public ArrayOfHostPlugStoreTopologyAdapter(
           com.vmware.converter.HostPlugStoreTopologyAdapter[] hostPlugStoreTopologyAdapter) {
     ...
     */
    public com.vmware.converter.HostPlugStoreTopologyAdapter[] getHostPlugStoreTopologyAdapter() {
        return hostPlugStoreTopologyAdapter;
    }
     ...
     */
    public void setHostPlugStoreTopologyAdapter(com.vmware.converter.HostPlugStoreTopologyAdapter[] hostPlugStoreTopologyAdapter) {
        this.hostPlugStoreTopologyAdapter = hostPlugStoreTopologyAdapter;
    }

    public com.vmware.converter.HostPlugStoreTopologyAdapter getHostPlugStoreTopologyAdapter(int i) {
        return this.hostPlugStoreTopologyAdapter[i];
    }

    public void setHostPlugStoreTopologyAdapter(int i, com.vmware.converter.HostPlugStoreTopologyAdapter _value) {
