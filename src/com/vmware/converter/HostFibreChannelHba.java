...
public class HostFibreChannelHba  extends com.vmware.converter.HostHostBusAdapter  implements java.io.Serializable {
    private long portWorldWideName;

    private long nodeWorldWideName;

    private com.vmware.converter.FibreChannelPortType portType;
     ...
     * @return portType
     */
    public com.vmware.converter.FibreChannelPortType getPortType() {
        return portType;
    }
     ...
     * @param portType
     */
    public void setPortType(com.vmware.converter.FibreChannelPortType portType) {
        this.portType = portType;
    }
