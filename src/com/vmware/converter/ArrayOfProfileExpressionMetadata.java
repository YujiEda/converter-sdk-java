...
public class ArrayOfProfileExpressionMetadata  implements java.io.Serializable {
    private com.vmware.converter.ProfileExpressionMetadata[] profileExpressionMetadata;

    public ArrayOfProfileExpressionMetadata() {
    }

    public ArrayOfProfileExpressionMetadata(
           com.vmware.converter.ProfileExpressionMetadata[] profileExpressionMetadata) {
     ...
     */
    public com.vmware.converter.ProfileExpressionMetadata[] getProfileExpressionMetadata() {
        return profileExpressionMetadata;
    }
     ...
     */
    public void setProfileExpressionMetadata(com.vmware.converter.ProfileExpressionMetadata[] profileExpressionMetadata) {
        this.profileExpressionMetadata = profileExpressionMetadata;
    }

    public com.vmware.converter.ProfileExpressionMetadata getProfileExpressionMetadata(int i) {
        return this.profileExpressionMetadata[i];
    }

    public void setProfileExpressionMetadata(int i, com.vmware.converter.ProfileExpressionMetadata _value) {
