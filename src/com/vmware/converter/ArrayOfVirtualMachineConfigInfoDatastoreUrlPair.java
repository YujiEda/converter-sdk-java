...
public class ArrayOfVirtualMachineConfigInfoDatastoreUrlPair  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineConfigInfoDatastoreUrlPair[] virtualMachineConfigInfoDatastoreUrlPair;

    public ArrayOfVirtualMachineConfigInfoDatastoreUrlPair() {
    }

    public ArrayOfVirtualMachineConfigInfoDatastoreUrlPair(
           com.vmware.converter.VirtualMachineConfigInfoDatastoreUrlPair[] virtualMachineConfigInfoDatastoreUrlPair) {
     ...
     */
    public com.vmware.converter.VirtualMachineConfigInfoDatastoreUrlPair[] getVirtualMachineConfigInfoDatastoreUrlPair() {
        return virtualMachineConfigInfoDatastoreUrlPair;
    }
     ...
     */
    public void setVirtualMachineConfigInfoDatastoreUrlPair(com.vmware.converter.VirtualMachineConfigInfoDatastoreUrlPair[] virtualMachineConfigInfoDatastoreUrlPair) {
        this.virtualMachineConfigInfoDatastoreUrlPair = virtualMachineConfigInfoDatastoreUrlPair;
    }

    public com.vmware.converter.VirtualMachineConfigInfoDatastoreUrlPair getVirtualMachineConfigInfoDatastoreUrlPair(int i) {
        return this.virtualMachineConfigInfoDatastoreUrlPair[i];
    }

    public void setVirtualMachineConfigInfoDatastoreUrlPair(int i, com.vmware.converter.VirtualMachineConfigInfoDatastoreUrlPair _value) {
