...
public class HostFirewallConfig  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostFirewallConfigRuleSetConfig[] rule;

    private com.vmware.converter.HostFirewallDefaultPolicy defaultBlockingPolicy;

    public HostFirewallConfig() {
    }

    public HostFirewallConfig(
           com.vmware.converter.HostFirewallConfigRuleSetConfig[] rule,
           com.vmware.converter.HostFirewallDefaultPolicy defaultBlockingPolicy) {
        this.rule = rule;
     ...
     * @return rule
     */
    public com.vmware.converter.HostFirewallConfigRuleSetConfig[] getRule() {
        return rule;
    }
     ...
     * @param rule
     */
    public void setRule(com.vmware.converter.HostFirewallConfigRuleSetConfig[] rule) {
        this.rule = rule;
    }

    public com.vmware.converter.HostFirewallConfigRuleSetConfig getRule(int i) {
        return this.rule[i];
    }

    public void setRule(int i, com.vmware.converter.HostFirewallConfigRuleSetConfig _value) {
        this.rule[i] = _value;
    }
     ...
     */
    public com.vmware.converter.HostFirewallDefaultPolicy getDefaultBlockingPolicy() {
        return defaultBlockingPolicy;
    }
     ...
     */
    public void setDefaultBlockingPolicy(com.vmware.converter.HostFirewallDefaultPolicy defaultBlockingPolicy) {
        this.defaultBlockingPolicy = defaultBlockingPolicy;
    }
