...
public class ArrayOfClusterAttemptedVmInfo  implements java.io.Serializable {
    private com.vmware.converter.ClusterAttemptedVmInfo[] clusterAttemptedVmInfo;

    public ArrayOfClusterAttemptedVmInfo() {
    }

    public ArrayOfClusterAttemptedVmInfo(
           com.vmware.converter.ClusterAttemptedVmInfo[] clusterAttemptedVmInfo) {
     ...
     */
    public com.vmware.converter.ClusterAttemptedVmInfo[] getClusterAttemptedVmInfo() {
        return clusterAttemptedVmInfo;
    }
     ...
     */
    public void setClusterAttemptedVmInfo(com.vmware.converter.ClusterAttemptedVmInfo[] clusterAttemptedVmInfo) {
        this.clusterAttemptedVmInfo = clusterAttemptedVmInfo;
    }

    public com.vmware.converter.ClusterAttemptedVmInfo getClusterAttemptedVmInfo(int i) {
        return this.clusterAttemptedVmInfo[i];
    }

    public void setClusterAttemptedVmInfo(int i, com.vmware.converter.ClusterAttemptedVmInfo _value) {
