...
public class ArrayOfMethodActionArgument  implements java.io.Serializable {
    private com.vmware.converter.MethodActionArgument[] methodActionArgument;

    public ArrayOfMethodActionArgument() {
    }

    public ArrayOfMethodActionArgument(
           com.vmware.converter.MethodActionArgument[] methodActionArgument) {
     ...
     */
    public com.vmware.converter.MethodActionArgument[] getMethodActionArgument() {
        return methodActionArgument;
    }
     ...
     */
    public void setMethodActionArgument(com.vmware.converter.MethodActionArgument[] methodActionArgument) {
        this.methodActionArgument = methodActionArgument;
    }

    public com.vmware.converter.MethodActionArgument getMethodActionArgument(int i) {
        return this.methodActionArgument[i];
    }

    public void setMethodActionArgument(int i, com.vmware.converter.MethodActionArgument _value) {
