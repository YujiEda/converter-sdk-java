...
public class ArrayOfVirtualMachineSerialInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineSerialInfo[] virtualMachineSerialInfo;

    public ArrayOfVirtualMachineSerialInfo() {
    }

    public ArrayOfVirtualMachineSerialInfo(
           com.vmware.converter.VirtualMachineSerialInfo[] virtualMachineSerialInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachineSerialInfo[] getVirtualMachineSerialInfo() {
        return virtualMachineSerialInfo;
    }
     ...
     */
    public void setVirtualMachineSerialInfo(com.vmware.converter.VirtualMachineSerialInfo[] virtualMachineSerialInfo) {
        this.virtualMachineSerialInfo = virtualMachineSerialInfo;
    }

    public com.vmware.converter.VirtualMachineSerialInfo getVirtualMachineSerialInfo(int i) {
        return this.virtualMachineSerialInfo[i];
    }

    public void setVirtualMachineSerialInfo(int i, com.vmware.converter.VirtualMachineSerialInfo _value) {
