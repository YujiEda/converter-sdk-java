...
public class ArrayOfAuthorizationRole  implements java.io.Serializable {
    private com.vmware.converter.AuthorizationRole[] authorizationRole;

    public ArrayOfAuthorizationRole() {
    }

    public ArrayOfAuthorizationRole(
           com.vmware.converter.AuthorizationRole[] authorizationRole) {
     ...
     */
    public com.vmware.converter.AuthorizationRole[] getAuthorizationRole() {
        return authorizationRole;
    }
     ...
     */
    public void setAuthorizationRole(com.vmware.converter.AuthorizationRole[] authorizationRole) {
        this.authorizationRole = authorizationRole;
    }

    public com.vmware.converter.AuthorizationRole getAuthorizationRole(int i) {
        return this.authorizationRole[i];
    }

    public void setAuthorizationRole(int i, com.vmware.converter.AuthorizationRole _value) {
