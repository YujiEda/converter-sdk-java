...
public class ComplianceProfile  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ProfileExpression[] expression;
    ...
    public ComplianceProfile(
           com.vmware.converter.ProfileExpression[] expression,
     ...
     * @return expression
     */
    public com.vmware.converter.ProfileExpression[] getExpression() {
        return expression;
    }
     ...
     * @param expression
     */
    public void setExpression(com.vmware.converter.ProfileExpression[] expression) {
        this.expression = expression;
    }

    public com.vmware.converter.ProfileExpression getExpression(int i) {
        return this.expression[i];
    }

    public void setExpression(int i, com.vmware.converter.ProfileExpression _value) {
