...
public class ArrayOfVirtualMachineRelocateSpecDiskLocator  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineRelocateSpecDiskLocator[] virtualMachineRelocateSpecDiskLocator;

    public ArrayOfVirtualMachineRelocateSpecDiskLocator() {
    }

    public ArrayOfVirtualMachineRelocateSpecDiskLocator(
           com.vmware.converter.VirtualMachineRelocateSpecDiskLocator[] virtualMachineRelocateSpecDiskLocator) {
     ...
     */
    public com.vmware.converter.VirtualMachineRelocateSpecDiskLocator[] getVirtualMachineRelocateSpecDiskLocator() {
        return virtualMachineRelocateSpecDiskLocator;
    }
     ...
     */
    public void setVirtualMachineRelocateSpecDiskLocator(com.vmware.converter.VirtualMachineRelocateSpecDiskLocator[] virtualMachineRelocateSpecDiskLocator) {
        this.virtualMachineRelocateSpecDiskLocator = virtualMachineRelocateSpecDiskLocator;
    }

    public com.vmware.converter.VirtualMachineRelocateSpecDiskLocator getVirtualMachineRelocateSpecDiskLocator(int i) {
        return this.virtualMachineRelocateSpecDiskLocator[i];
    }

    public void setVirtualMachineRelocateSpecDiskLocator(int i, com.vmware.converter.VirtualMachineRelocateSpecDiskLocator _value) {
