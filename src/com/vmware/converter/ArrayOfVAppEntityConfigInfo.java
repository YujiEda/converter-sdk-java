...
public class ArrayOfVAppEntityConfigInfo  implements java.io.Serializable {
    private com.vmware.converter.VAppEntityConfigInfo[] VAppEntityConfigInfo;

    public ArrayOfVAppEntityConfigInfo() {
    }

    public ArrayOfVAppEntityConfigInfo(
           com.vmware.converter.VAppEntityConfigInfo[] VAppEntityConfigInfo) {
     ...
     */
    public com.vmware.converter.VAppEntityConfigInfo[] getVAppEntityConfigInfo() {
        return VAppEntityConfigInfo;
    }
     ...
     */
    public void setVAppEntityConfigInfo(com.vmware.converter.VAppEntityConfigInfo[] VAppEntityConfigInfo) {
        this.VAppEntityConfigInfo = VAppEntityConfigInfo;
    }

    public com.vmware.converter.VAppEntityConfigInfo getVAppEntityConfigInfo(int i) {
        return this.VAppEntityConfigInfo[i];
    }

    public void setVAppEntityConfigInfo(int i, com.vmware.converter.VAppEntityConfigInfo _value) {
