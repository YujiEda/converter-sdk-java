...
public class ArrayOfLocalizableMessage  implements java.io.Serializable {
    private com.vmware.converter.LocalizableMessage[] localizableMessage;

    public ArrayOfLocalizableMessage() {
    }

    public ArrayOfLocalizableMessage(
           com.vmware.converter.LocalizableMessage[] localizableMessage) {
     ...
     */
    public com.vmware.converter.LocalizableMessage[] getLocalizableMessage() {
        return localizableMessage;
    }
     ...
     */
    public void setLocalizableMessage(com.vmware.converter.LocalizableMessage[] localizableMessage) {
        this.localizableMessage = localizableMessage;
    }

    public com.vmware.converter.LocalizableMessage getLocalizableMessage(int i) {
        return this.localizableMessage[i];
    }

    public void setLocalizableMessage(int i, com.vmware.converter.LocalizableMessage _value) {
