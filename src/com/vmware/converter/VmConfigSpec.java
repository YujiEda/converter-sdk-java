...
public class VmConfigSpec  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.VAppProductSpec[] product;

    private com.vmware.converter.VAppPropertySpec[] property;

    private com.vmware.converter.VAppIPAssignmentInfo ipAssignment;

    private java.lang.String[] eula;

    private com.vmware.converter.VAppOvfSectionSpec[] ovfSection;
    ...
    public VmConfigSpec(
           com.vmware.converter.VAppProductSpec[] product,
           com.vmware.converter.VAppPropertySpec[] property,
           com.vmware.converter.VAppIPAssignmentInfo ipAssignment,
           java.lang.String[] eula,
           com.vmware.converter.VAppOvfSectionSpec[] ovfSection,
     ...
     * @return product
     */
    public com.vmware.converter.VAppProductSpec[] getProduct() {
        return product;
    }
     ...
     * @param product
     */
    public void setProduct(com.vmware.converter.VAppProductSpec[] product) {
        this.product = product;
    }

    public com.vmware.converter.VAppProductSpec getProduct(int i) {
        return this.product[i];
    }

    public void setProduct(int i, com.vmware.converter.VAppProductSpec _value) {
     ...
     * @return property
     */
    public com.vmware.converter.VAppPropertySpec[] getProperty() {
        return property;
    }
     ...
     * @param property
     */
    public void setProperty(com.vmware.converter.VAppPropertySpec[] property) {
        this.property = property;
    }

    public com.vmware.converter.VAppPropertySpec getProperty(int i) {
        return this.property[i];
    }

    public void setProperty(int i, com.vmware.converter.VAppPropertySpec _value) {
     ...
     * @return ipAssignment
     */
    public com.vmware.converter.VAppIPAssignmentInfo getIpAssignment() {
        return ipAssignment;
    }
     ...
     * @param ipAssignment
     */
    public void setIpAssignment(com.vmware.converter.VAppIPAssignmentInfo ipAssignment) {
        this.ipAssignment = ipAssignment;
    }
     ...
     * @return ovfSection
     */
    public com.vmware.converter.VAppOvfSectionSpec[] getOvfSection() {
        return ovfSection;
    }
     ...
     * @param ovfSection
     */
    public void setOvfSection(com.vmware.converter.VAppOvfSectionSpec[] ovfSection) {
        this.ovfSection = ovfSection;
    }

    public com.vmware.converter.VAppOvfSectionSpec getOvfSection(int i) {
        return this.ovfSection[i];
    }

    public void setOvfSection(int i, com.vmware.converter.VAppOvfSectionSpec _value) {
