...
public class HostDateTimeInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostDateTimeSystemTimeZone timeZone;

    private com.vmware.converter.HostNtpConfig ntpConfig;

    public HostDateTimeInfo() {
    }

    public HostDateTimeInfo(
           com.vmware.converter.HostDateTimeSystemTimeZone timeZone,
           com.vmware.converter.HostNtpConfig ntpConfig) {
     ...
     * @return timeZone
     */
    public com.vmware.converter.HostDateTimeSystemTimeZone getTimeZone() {
        return timeZone;
    }
     ...
     * @param timeZone
     */
    public void setTimeZone(com.vmware.converter.HostDateTimeSystemTimeZone timeZone) {
        this.timeZone = timeZone;
    }
     ...
     * @return ntpConfig
     */
    public com.vmware.converter.HostNtpConfig getNtpConfig() {
        return ntpConfig;
    }
     ...
     * @param ntpConfig
     */
    public void setNtpConfig(com.vmware.converter.HostNtpConfig ntpConfig) {
        this.ntpConfig = ntpConfig;
    }
