...
public class ArrayOfHostAccountSpec  implements java.io.Serializable {
    private com.vmware.converter.HostAccountSpec[] hostAccountSpec;

    public ArrayOfHostAccountSpec() {
    }

    public ArrayOfHostAccountSpec(
           com.vmware.converter.HostAccountSpec[] hostAccountSpec) {
     ...
     */
    public com.vmware.converter.HostAccountSpec[] getHostAccountSpec() {
        return hostAccountSpec;
    }
     ...
     */
    public void setHostAccountSpec(com.vmware.converter.HostAccountSpec[] hostAccountSpec) {
        this.hostAccountSpec = hostAccountSpec;
    }

    public com.vmware.converter.HostAccountSpec getHostAccountSpec(int i) {
        return this.hostAccountSpec[i];
    }

    public void setHostAccountSpec(int i, com.vmware.converter.HostAccountSpec _value) {
