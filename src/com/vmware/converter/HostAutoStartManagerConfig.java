...
public class HostAutoStartManagerConfig  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.AutoStartDefaults defaults;

    private com.vmware.converter.AutoStartPowerInfo[] powerInfo;

    public HostAutoStartManagerConfig() {
    }

    public HostAutoStartManagerConfig(
           com.vmware.converter.AutoStartDefaults defaults,
           com.vmware.converter.AutoStartPowerInfo[] powerInfo) {
     ...
     * @return defaults
     */
    public com.vmware.converter.AutoStartDefaults getDefaults() {
        return defaults;
    }
     ...
     * @param defaults
     */
    public void setDefaults(com.vmware.converter.AutoStartDefaults defaults) {
        this.defaults = defaults;
    }
     ...
     * @return powerInfo
     */
    public com.vmware.converter.AutoStartPowerInfo[] getPowerInfo() {
        return powerInfo;
    }
     ...
     * @param powerInfo
     */
    public void setPowerInfo(com.vmware.converter.AutoStartPowerInfo[] powerInfo) {
        this.powerInfo = powerInfo;
    }

    public com.vmware.converter.AutoStartPowerInfo getPowerInfo(int i) {
        return this.powerInfo[i];
    }

    public void setPowerInfo(int i, com.vmware.converter.AutoStartPowerInfo _value) {
