...
public class HostSystemResourceInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private java.lang.String key;

    private com.vmware.converter.ResourceConfigSpec config;

    private com.vmware.converter.HostSystemResourceInfo[] child;
    ...
    public HostSystemResourceInfo(
           ...
           com.vmware.converter.HostSystemResourceInfo[] child) {
        this.key = key;
        this.config = config;
        this.child = child;
    }
     ...
     * @return child
     */
    public com.vmware.converter.HostSystemResourceInfo[] getChild() {
        return child;
    }
     ...
     * @param child
     */
    public void setChild(com.vmware.converter.HostSystemResourceInfo[] child) {
        this.child = child;
    }

    public com.vmware.converter.HostSystemResourceInfo getChild(int i) {
        return this.child[i];
    }

    public void setChild(int i, com.vmware.converter.HostSystemResourceInfo _value) {
        this.child[i] = _value;
    }
