...
public class ArrayOfOvfFileItem  implements java.io.Serializable {
    private com.vmware.converter.OvfFileItem[] ovfFileItem;

    public ArrayOfOvfFileItem() {
    }

    public ArrayOfOvfFileItem(
           com.vmware.converter.OvfFileItem[] ovfFileItem) {
     ...
     * @return ovfFileItem
     */
    public com.vmware.converter.OvfFileItem[] getOvfFileItem() {
        return ovfFileItem;
    }
     ...
     * @param ovfFileItem
     */
    public void setOvfFileItem(com.vmware.converter.OvfFileItem[] ovfFileItem) {
        this.ovfFileItem = ovfFileItem;
    }

    public com.vmware.converter.OvfFileItem getOvfFileItem(int i) {
        return this.ovfFileItem[i];
    }

    public void setOvfFileItem(int i, com.vmware.converter.OvfFileItem _value) {
