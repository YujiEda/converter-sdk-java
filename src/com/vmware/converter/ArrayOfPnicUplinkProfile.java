...
public class ArrayOfPnicUplinkProfile  implements java.io.Serializable {
    private com.vmware.converter.PnicUplinkProfile[] pnicUplinkProfile;

    public ArrayOfPnicUplinkProfile() {
    }

    public ArrayOfPnicUplinkProfile(
           com.vmware.converter.PnicUplinkProfile[] pnicUplinkProfile) {
     ...
     */
    public com.vmware.converter.PnicUplinkProfile[] getPnicUplinkProfile() {
        return pnicUplinkProfile;
    }
     ...
     */
    public void setPnicUplinkProfile(com.vmware.converter.PnicUplinkProfile[] pnicUplinkProfile) {
        this.pnicUplinkProfile = pnicUplinkProfile;
    }

    public com.vmware.converter.PnicUplinkProfile getPnicUplinkProfile(int i) {
        return this.pnicUplinkProfile[i];
    }

    public void setPnicUplinkProfile(int i, com.vmware.converter.PnicUplinkProfile _value) {
