...
public class ArrayOfPerfQuerySpec  implements java.io.Serializable {
    private com.vmware.converter.PerfQuerySpec[] perfQuerySpec;

    public ArrayOfPerfQuerySpec() {
    }

    public ArrayOfPerfQuerySpec(
           com.vmware.converter.PerfQuerySpec[] perfQuerySpec) {
     ...
     */
    public com.vmware.converter.PerfQuerySpec[] getPerfQuerySpec() {
        return perfQuerySpec;
    }
     ...
     * @param perfQuerySpec
     */
    public void setPerfQuerySpec(com.vmware.converter.PerfQuerySpec[] perfQuerySpec) {
        this.perfQuerySpec = perfQuerySpec;
    }

    public com.vmware.converter.PerfQuerySpec getPerfQuerySpec(int i) {
        return this.perfQuerySpec[i];
    }

    public void setPerfQuerySpec(int i, com.vmware.converter.PerfQuerySpec _value) {
