...
public class ArrayOfUserGroupProfile  implements java.io.Serializable {
    private com.vmware.converter.UserGroupProfile[] userGroupProfile;

    public ArrayOfUserGroupProfile() {
    }

    public ArrayOfUserGroupProfile(
           com.vmware.converter.UserGroupProfile[] userGroupProfile) {
     ...
     */
    public com.vmware.converter.UserGroupProfile[] getUserGroupProfile() {
        return userGroupProfile;
    }
     ...
     */
    public void setUserGroupProfile(com.vmware.converter.UserGroupProfile[] userGroupProfile) {
        this.userGroupProfile = userGroupProfile;
    }

    public com.vmware.converter.UserGroupProfile getUserGroupProfile(int i) {
        return this.userGroupProfile[i];
    }

    public void setUserGroupProfile(int i, com.vmware.converter.UserGroupProfile _value) {
