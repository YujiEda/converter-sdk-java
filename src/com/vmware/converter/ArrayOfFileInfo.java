...
public class ArrayOfFileInfo  implements java.io.Serializable {
    private com.vmware.converter.FileInfo[] fileInfo;

    public ArrayOfFileInfo() {
    }

    public ArrayOfFileInfo(
           com.vmware.converter.FileInfo[] fileInfo) {
     ...
     * @return fileInfo
     */
    public com.vmware.converter.FileInfo[] getFileInfo() {
        return fileInfo;
    }
     ...
     * @param fileInfo
     */
    public void setFileInfo(com.vmware.converter.FileInfo[] fileInfo) {
        this.fileInfo = fileInfo;
    }

    public com.vmware.converter.FileInfo getFileInfo(int i) {
        return this.fileInfo[i];
    }

    public void setFileInfo(int i, com.vmware.converter.FileInfo _value) {
