...
public class DatastoreSummary  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    /**
     * Gets the maintenanceMode value for this DatastoreSummary.
     * 
    ...
    /**
     * Sets the maintenanceMode value for this DatastoreSummary.
     * 
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "maintenanceMode"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
