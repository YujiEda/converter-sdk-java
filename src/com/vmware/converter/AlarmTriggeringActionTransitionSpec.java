...
public class AlarmTriggeringActionTransitionSpec  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ManagedEntityStatus startState;

    private com.vmware.converter.ManagedEntityStatus finalState;
    ...
    public AlarmTriggeringActionTransitionSpec(
           com.vmware.converter.ManagedEntityStatus startState,
           com.vmware.converter.ManagedEntityStatus finalState,
           boolean repeats) {
     ...
     * @return startState
     */
    public com.vmware.converter.ManagedEntityStatus getStartState() {
        return startState;
    }
     ...
     * @param startState
     */
    public void setStartState(com.vmware.converter.ManagedEntityStatus startState) {
        this.startState = startState;
    }
     ...
     * @return finalState
     */
    public com.vmware.converter.ManagedEntityStatus getFinalState() {
        return finalState;
    }
     ...
     * @param finalState
     */
    public void setFinalState(com.vmware.converter.ManagedEntityStatus finalState) {
        this.finalState = finalState;
    }
