...
public class ArrayOfDiagnosticManagerBundleInfo  implements java.io.Serializable {
    private com.vmware.converter.DiagnosticManagerBundleInfo[] diagnosticManagerBundleInfo;

    public ArrayOfDiagnosticManagerBundleInfo() {
    }

    public ArrayOfDiagnosticManagerBundleInfo(
           com.vmware.converter.DiagnosticManagerBundleInfo[] diagnosticManagerBundleInfo) {
     ...
     */
    public com.vmware.converter.DiagnosticManagerBundleInfo[] getDiagnosticManagerBundleInfo() {
        return diagnosticManagerBundleInfo;
    }
     ...
     */
    public void setDiagnosticManagerBundleInfo(com.vmware.converter.DiagnosticManagerBundleInfo[] diagnosticManagerBundleInfo) {
        this.diagnosticManagerBundleInfo = diagnosticManagerBundleInfo;
    }

    public com.vmware.converter.DiagnosticManagerBundleInfo getDiagnosticManagerBundleInfo(int i) {
        return this.diagnosticManagerBundleInfo[i];
    }

    public void setDiagnosticManagerBundleInfo(int i, com.vmware.converter.DiagnosticManagerBundleInfo _value) {
