...
public class ArrayOfHostNatServicePortForwardSpec  implements java.io.Serializable {
    private com.vmware.converter.HostNatServicePortForwardSpec[] hostNatServicePortForwardSpec;

    public ArrayOfHostNatServicePortForwardSpec() {
    }

    public ArrayOfHostNatServicePortForwardSpec(
           com.vmware.converter.HostNatServicePortForwardSpec[] hostNatServicePortForwardSpec) {
     ...
     */
    public com.vmware.converter.HostNatServicePortForwardSpec[] getHostNatServicePortForwardSpec() {
        return hostNatServicePortForwardSpec;
    }
     ...
     */
    public void setHostNatServicePortForwardSpec(com.vmware.converter.HostNatServicePortForwardSpec[] hostNatServicePortForwardSpec) {
        this.hostNatServicePortForwardSpec = hostNatServicePortForwardSpec;
    }

    public com.vmware.converter.HostNatServicePortForwardSpec getHostNatServicePortForwardSpec(int i) {
        return this.hostNatServicePortForwardSpec[i];
    }

    public void setHostNatServicePortForwardSpec(int i, com.vmware.converter.HostNatServicePortForwardSpec _value) {
