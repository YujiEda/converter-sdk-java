...
public class ArrayOfHostPortGroupProfile  implements java.io.Serializable {
    private com.vmware.converter.HostPortGroupProfile[] hostPortGroupProfile;

    public ArrayOfHostPortGroupProfile() {
    }

    public ArrayOfHostPortGroupProfile(
           com.vmware.converter.HostPortGroupProfile[] hostPortGroupProfile) {
     ...
     */
    public com.vmware.converter.HostPortGroupProfile[] getHostPortGroupProfile() {
        return hostPortGroupProfile;
    }
     ...
     */
    public void setHostPortGroupProfile(com.vmware.converter.HostPortGroupProfile[] hostPortGroupProfile) {
        this.hostPortGroupProfile = hostPortGroupProfile;
    }

    public com.vmware.converter.HostPortGroupProfile getHostPortGroupProfile(int i) {
        return this.hostPortGroupProfile[i];
    }

    public void setHostPortGroupProfile(int i, com.vmware.converter.HostPortGroupProfile _value) {
