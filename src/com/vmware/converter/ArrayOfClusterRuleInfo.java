...
public class ArrayOfClusterRuleInfo  implements java.io.Serializable {
    private com.vmware.converter.ClusterRuleInfo[] clusterRuleInfo;

    public ArrayOfClusterRuleInfo() {
    }

    public ArrayOfClusterRuleInfo(
           com.vmware.converter.ClusterRuleInfo[] clusterRuleInfo) {
     ...
     */
    public com.vmware.converter.ClusterRuleInfo[] getClusterRuleInfo() {
        return clusterRuleInfo;
    }
     ...
     */
    public void setClusterRuleInfo(com.vmware.converter.ClusterRuleInfo[] clusterRuleInfo) {
        this.clusterRuleInfo = clusterRuleInfo;
    }

    public com.vmware.converter.ClusterRuleInfo getClusterRuleInfo(int i) {
        return this.clusterRuleInfo[i];
    }

    public void setClusterRuleInfo(int i, com.vmware.converter.ClusterRuleInfo _value) {
