...
public class VirtualMachineStorageInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineUsageOnDatastore[] perDatastoreUsage;
    ...
    public VirtualMachineStorageInfo(
           com.vmware.converter.VirtualMachineUsageOnDatastore[] perDatastoreUsage,
     ...
     */
    public com.vmware.converter.VirtualMachineUsageOnDatastore[] getPerDatastoreUsage() {
        return perDatastoreUsage;
    }
     ...
     */
    public void setPerDatastoreUsage(com.vmware.converter.VirtualMachineUsageOnDatastore[] perDatastoreUsage) {
        this.perDatastoreUsage = perDatastoreUsage;
    }

    public com.vmware.converter.VirtualMachineUsageOnDatastore getPerDatastoreUsage(int i) {
        return this.perDatastoreUsage[i];
    }

    public void setPerDatastoreUsage(int i, com.vmware.converter.VirtualMachineUsageOnDatastore _value) {
