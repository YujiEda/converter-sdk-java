...
public class EventAlarmExpression  extends com.vmware.converter.AlarmExpression  implements java.io.Serializable {
    private com.vmware.converter.EventAlarmExpressionComparison[] comparisons;
    ...
    public EventAlarmExpression(
           com.vmware.converter.EventAlarmExpressionComparison[] comparisons,
     ...
     * @return comparisons
     */
    public com.vmware.converter.EventAlarmExpressionComparison[] getComparisons() {
        return comparisons;
    }
     ...
     * @param comparisons
     */
    public void setComparisons(com.vmware.converter.EventAlarmExpressionComparison[] comparisons) {
        this.comparisons = comparisons;
    }

    public com.vmware.converter.EventAlarmExpressionComparison getComparisons(int i) {
        return this.comparisons[i];
    }

    public void setComparisons(int i, com.vmware.converter.EventAlarmExpressionComparison _value) {
