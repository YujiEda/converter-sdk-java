...
public class ArrayOfDistributedVirtualSwitchHostMember  implements java.io.Serializable {
    private com.vmware.converter.DistributedVirtualSwitchHostMember[] distributedVirtualSwitchHostMember;

    public ArrayOfDistributedVirtualSwitchHostMember() {
    }

    public ArrayOfDistributedVirtualSwitchHostMember(
           com.vmware.converter.DistributedVirtualSwitchHostMember[] distributedVirtualSwitchHostMember) {
     ...
     */
    public com.vmware.converter.DistributedVirtualSwitchHostMember[] getDistributedVirtualSwitchHostMember() {
        return distributedVirtualSwitchHostMember;
    }
     ...
     */
    public void setDistributedVirtualSwitchHostMember(com.vmware.converter.DistributedVirtualSwitchHostMember[] distributedVirtualSwitchHostMember) {
        this.distributedVirtualSwitchHostMember = distributedVirtualSwitchHostMember;
    }

    public com.vmware.converter.DistributedVirtualSwitchHostMember getDistributedVirtualSwitchHostMember(int i) {
        return this.distributedVirtualSwitchHostMember[i];
    }

    public void setDistributedVirtualSwitchHostMember(int i, com.vmware.converter.DistributedVirtualSwitchHostMember _value) {
