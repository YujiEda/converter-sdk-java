...
public class ArrayOfHostDatastoreBrowserSearchResults  implements java.io.Serializable {
    private com.vmware.converter.HostDatastoreBrowserSearchResults[] hostDatastoreBrowserSearchResults;

    public ArrayOfHostDatastoreBrowserSearchResults() {
    }

    public ArrayOfHostDatastoreBrowserSearchResults(
           com.vmware.converter.HostDatastoreBrowserSearchResults[] hostDatastoreBrowserSearchResults) {
     ...
     */
    public com.vmware.converter.HostDatastoreBrowserSearchResults[] getHostDatastoreBrowserSearchResults() {
        return hostDatastoreBrowserSearchResults;
    }
     ...
     */
    public void setHostDatastoreBrowserSearchResults(com.vmware.converter.HostDatastoreBrowserSearchResults[] hostDatastoreBrowserSearchResults) {
        this.hostDatastoreBrowserSearchResults = hostDatastoreBrowserSearchResults;
    }

    public com.vmware.converter.HostDatastoreBrowserSearchResults getHostDatastoreBrowserSearchResults(int i) {
        return this.hostDatastoreBrowserSearchResults[i];
    }

    public void setHostDatastoreBrowserSearchResults(int i, com.vmware.converter.HostDatastoreBrowserSearchResults _value) {
