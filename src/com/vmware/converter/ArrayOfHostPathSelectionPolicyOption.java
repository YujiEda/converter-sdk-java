...
public class ArrayOfHostPathSelectionPolicyOption  implements java.io.Serializable {
    private com.vmware.converter.HostPathSelectionPolicyOption[] hostPathSelectionPolicyOption;

    public ArrayOfHostPathSelectionPolicyOption() {
    }

    public ArrayOfHostPathSelectionPolicyOption(
           com.vmware.converter.HostPathSelectionPolicyOption[] hostPathSelectionPolicyOption) {
     ...
     */
    public com.vmware.converter.HostPathSelectionPolicyOption[] getHostPathSelectionPolicyOption() {
        return hostPathSelectionPolicyOption;
    }
     ...
     */
    public void setHostPathSelectionPolicyOption(com.vmware.converter.HostPathSelectionPolicyOption[] hostPathSelectionPolicyOption) {
        this.hostPathSelectionPolicyOption = hostPathSelectionPolicyOption;
    }

    public com.vmware.converter.HostPathSelectionPolicyOption getHostPathSelectionPolicyOption(int i) {
        return this.hostPathSelectionPolicyOption[i];
    }

    public void setHostPathSelectionPolicyOption(int i, com.vmware.converter.HostPathSelectionPolicyOption _value) {
