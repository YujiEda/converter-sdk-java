...
public class CreateFilterRequestType  implements java.io.Serializable {
    ...
    private com.vmware.converter.PropertyFilterSpec spec;
    ...
    public CreateFilterRequestType(
           ...
           com.vmware.converter.PropertyFilterSpec spec,
     ...
     * @return spec
     */
    public com.vmware.converter.PropertyFilterSpec getSpec() {
        return spec;
    }
     ...
     * @param spec
     */
    public void setSpec(com.vmware.converter.PropertyFilterSpec spec) {
        this.spec = spec;
    }
