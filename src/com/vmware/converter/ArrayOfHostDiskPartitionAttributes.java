...
public class ArrayOfHostDiskPartitionAttributes  implements java.io.Serializable {
    private com.vmware.converter.HostDiskPartitionAttributes[] hostDiskPartitionAttributes;

    public ArrayOfHostDiskPartitionAttributes() {
    }

    public ArrayOfHostDiskPartitionAttributes(
           com.vmware.converter.HostDiskPartitionAttributes[] hostDiskPartitionAttributes) {
     ...
     */
    public com.vmware.converter.HostDiskPartitionAttributes[] getHostDiskPartitionAttributes() {
        return hostDiskPartitionAttributes;
    }
     ...
     */
    public void setHostDiskPartitionAttributes(com.vmware.converter.HostDiskPartitionAttributes[] hostDiskPartitionAttributes) {
        this.hostDiskPartitionAttributes = hostDiskPartitionAttributes;
    }

    public com.vmware.converter.HostDiskPartitionAttributes getHostDiskPartitionAttributes(int i) {
        return this.hostDiskPartitionAttributes[i];
    }

    public void setHostDiskPartitionAttributes(int i, com.vmware.converter.HostDiskPartitionAttributes _value) {
