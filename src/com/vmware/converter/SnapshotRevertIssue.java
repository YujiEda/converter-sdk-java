...
public class SnapshotRevertIssue  extends com.vmware.converter.MigrationFault  implements java.io.Serializable {
    private java.lang.String snapshotName;

    private com.vmware.converter.Event[] event;
    ...
    public SnapshotRevertIssue(
           ...
           com.vmware.converter.Event[] event,
           boolean errors) {
        super(
            faultCause,
            faultMessage);
     ...
     * @return event
     */
    public com.vmware.converter.Event[] getEvent() {
        return event;
    }
     ...
     * @param event
     */
    public void setEvent(com.vmware.converter.Event[] event) {
        this.event = event;
    }

    public com.vmware.converter.Event getEvent(int i) {
        return this.event[i];
    }

    public void setEvent(int i, com.vmware.converter.Event _value) {
        this.event[i] = _value;
    }
