...
public class ArrayOfExtensionResourceInfo  implements java.io.Serializable {
    private com.vmware.converter.ExtensionResourceInfo[] extensionResourceInfo;

    public ArrayOfExtensionResourceInfo() {
    }

    public ArrayOfExtensionResourceInfo(
           com.vmware.converter.ExtensionResourceInfo[] extensionResourceInfo) {
     ...
     */
    public com.vmware.converter.ExtensionResourceInfo[] getExtensionResourceInfo() {
        return extensionResourceInfo;
    }
     ...
     */
    public void setExtensionResourceInfo(com.vmware.converter.ExtensionResourceInfo[] extensionResourceInfo) {
        this.extensionResourceInfo = extensionResourceInfo;
    }

    public com.vmware.converter.ExtensionResourceInfo getExtensionResourceInfo(int i) {
        return this.extensionResourceInfo[i];
    }

    public void setExtensionResourceInfo(int i, com.vmware.converter.ExtensionResourceInfo _value) {
