...
public class ArrayOfVirtualMachineFileLayoutExFileInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] virtualMachineFileLayoutExFileInfo;

    public ArrayOfVirtualMachineFileLayoutExFileInfo() {
    }

    public ArrayOfVirtualMachineFileLayoutExFileInfo(
           com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] virtualMachineFileLayoutExFileInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] getVirtualMachineFileLayoutExFileInfo() {
        return virtualMachineFileLayoutExFileInfo;
    }
     ...
     */
    public void setVirtualMachineFileLayoutExFileInfo(com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] virtualMachineFileLayoutExFileInfo) {
        this.virtualMachineFileLayoutExFileInfo = virtualMachineFileLayoutExFileInfo;
    }

    public com.vmware.converter.VirtualMachineFileLayoutExFileInfo getVirtualMachineFileLayoutExFileInfo(int i) {
        return this.virtualMachineFileLayoutExFileInfo[i];
    }

    public void setVirtualMachineFileLayoutExFileInfo(int i, com.vmware.converter.VirtualMachineFileLayoutExFileInfo _value) {
