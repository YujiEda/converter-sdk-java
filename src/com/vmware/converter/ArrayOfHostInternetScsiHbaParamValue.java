...
public class ArrayOfHostInternetScsiHbaParamValue  implements java.io.Serializable {
    private com.vmware.converter.HostInternetScsiHbaParamValue[] hostInternetScsiHbaParamValue;

    public ArrayOfHostInternetScsiHbaParamValue() {
    }

    public ArrayOfHostInternetScsiHbaParamValue(
           com.vmware.converter.HostInternetScsiHbaParamValue[] hostInternetScsiHbaParamValue) {
     ...
     */
    public com.vmware.converter.HostInternetScsiHbaParamValue[] getHostInternetScsiHbaParamValue() {
        return hostInternetScsiHbaParamValue;
    }
     ...
     */
    public void setHostInternetScsiHbaParamValue(com.vmware.converter.HostInternetScsiHbaParamValue[] hostInternetScsiHbaParamValue) {
        this.hostInternetScsiHbaParamValue = hostInternetScsiHbaParamValue;
    }

    public com.vmware.converter.HostInternetScsiHbaParamValue getHostInternetScsiHbaParamValue(int i) {
        return this.hostInternetScsiHbaParamValue[i];
    }

    public void setHostInternetScsiHbaParamValue(int i, com.vmware.converter.HostInternetScsiHbaParamValue _value) {
