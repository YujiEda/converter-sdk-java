...
public class ArrayOfVnicPortArgument  implements java.io.Serializable {
    private com.vmware.converter.VnicPortArgument[] vnicPortArgument;

    public ArrayOfVnicPortArgument() {
    }

    public ArrayOfVnicPortArgument(
           com.vmware.converter.VnicPortArgument[] vnicPortArgument) {
     ...
     */
    public com.vmware.converter.VnicPortArgument[] getVnicPortArgument() {
        return vnicPortArgument;
    }
     ...
     */
    public void setVnicPortArgument(com.vmware.converter.VnicPortArgument[] vnicPortArgument) {
        this.vnicPortArgument = vnicPortArgument;
    }

    public com.vmware.converter.VnicPortArgument getVnicPortArgument(int i) {
        return this.vnicPortArgument[i];
    }

    public void setVnicPortArgument(int i, com.vmware.converter.VnicPortArgument _value) {
