...
public class ArrayOfServiceProfile  implements java.io.Serializable {
    private com.vmware.converter.ServiceProfile[] serviceProfile;

    public ArrayOfServiceProfile() {
    }

    public ArrayOfServiceProfile(
           com.vmware.converter.ServiceProfile[] serviceProfile) {
     ...
     */
    public com.vmware.converter.ServiceProfile[] getServiceProfile() {
        return serviceProfile;
    }
     ...
     */
    public void setServiceProfile(com.vmware.converter.ServiceProfile[] serviceProfile) {
        this.serviceProfile = serviceProfile;
    }

    public com.vmware.converter.ServiceProfile getServiceProfile(int i) {
        return this.serviceProfile[i];
    }

    public void setServiceProfile(int i, com.vmware.converter.ServiceProfile _value) {
