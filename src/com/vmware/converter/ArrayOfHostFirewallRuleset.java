...
public class ArrayOfHostFirewallRuleset  implements java.io.Serializable {
    private com.vmware.converter.HostFirewallRuleset[] hostFirewallRuleset;

    public ArrayOfHostFirewallRuleset() {
    }

    public ArrayOfHostFirewallRuleset(
           com.vmware.converter.HostFirewallRuleset[] hostFirewallRuleset) {
     ...
     */
    public com.vmware.converter.HostFirewallRuleset[] getHostFirewallRuleset() {
        return hostFirewallRuleset;
    }
     ...
     */
    public void setHostFirewallRuleset(com.vmware.converter.HostFirewallRuleset[] hostFirewallRuleset) {
        this.hostFirewallRuleset = hostFirewallRuleset;
    }

    public com.vmware.converter.HostFirewallRuleset getHostFirewallRuleset(int i) {
        return this.hostFirewallRuleset[i];
    }

    public void setHostFirewallRuleset(int i, com.vmware.converter.HostFirewallRuleset _value) {
