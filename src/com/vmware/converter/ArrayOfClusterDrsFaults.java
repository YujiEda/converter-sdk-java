...
public class ArrayOfClusterDrsFaults  implements java.io.Serializable {
    private com.vmware.converter.ClusterDrsFaults[] clusterDrsFaults;

    public ArrayOfClusterDrsFaults() {
    }

    public ArrayOfClusterDrsFaults(
           com.vmware.converter.ClusterDrsFaults[] clusterDrsFaults) {
     ...
     */
    public com.vmware.converter.ClusterDrsFaults[] getClusterDrsFaults() {
        return clusterDrsFaults;
    }
     ...
     */
    public void setClusterDrsFaults(com.vmware.converter.ClusterDrsFaults[] clusterDrsFaults) {
        this.clusterDrsFaults = clusterDrsFaults;
    }

    public com.vmware.converter.ClusterDrsFaults getClusterDrsFaults(int i) {
        return this.clusterDrsFaults[i];
    }

    public void setClusterDrsFaults(int i, com.vmware.converter.ClusterDrsFaults _value) {
