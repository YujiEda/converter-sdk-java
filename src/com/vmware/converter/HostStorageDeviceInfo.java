...
public class HostStorageDeviceInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostHostBusAdapter[] hostBusAdapter;

    private com.vmware.converter.ScsiLun[] scsiLun;

    private com.vmware.converter.HostScsiTopology scsiTopology;

    private com.vmware.converter.HostMultipathInfo multipathInfo;

    private com.vmware.converter.HostPlugStoreTopology plugStoreTopology;
    ...
    public HostStorageDeviceInfo(
           com.vmware.converter.HostHostBusAdapter[] hostBusAdapter,
           com.vmware.converter.ScsiLun[] scsiLun,
           com.vmware.converter.HostScsiTopology scsiTopology,
           com.vmware.converter.HostMultipathInfo multipathInfo,
           com.vmware.converter.HostPlugStoreTopology plugStoreTopology,
     ...
     */
    public com.vmware.converter.HostHostBusAdapter[] getHostBusAdapter() {
        return hostBusAdapter;
    }
     ...
     */
    public void setHostBusAdapter(com.vmware.converter.HostHostBusAdapter[] hostBusAdapter) {
        this.hostBusAdapter = hostBusAdapter;
    }

    public com.vmware.converter.HostHostBusAdapter getHostBusAdapter(int i) {
        return this.hostBusAdapter[i];
    }

    public void setHostBusAdapter(int i, com.vmware.converter.HostHostBusAdapter _value) {
     ...
     * @return scsiLun
     */
    public com.vmware.converter.ScsiLun[] getScsiLun() {
        return scsiLun;
    }
     ...
     * @param scsiLun
     */
    public void setScsiLun(com.vmware.converter.ScsiLun[] scsiLun) {
        this.scsiLun = scsiLun;
    }

    public com.vmware.converter.ScsiLun getScsiLun(int i) {
        return this.scsiLun[i];
    }

    public void setScsiLun(int i, com.vmware.converter.ScsiLun _value) {
     ...
     * @return scsiTopology
     */
    public com.vmware.converter.HostScsiTopology getScsiTopology() {
        return scsiTopology;
    }
     ...
     * @param scsiTopology
     */
    public void setScsiTopology(com.vmware.converter.HostScsiTopology scsiTopology) {
        this.scsiTopology = scsiTopology;
    }
     ...
     */
    public com.vmware.converter.HostMultipathInfo getMultipathInfo() {
        return multipathInfo;
    }
     ...
     * @param multipathInfo
     */
    public void setMultipathInfo(com.vmware.converter.HostMultipathInfo multipathInfo) {
        this.multipathInfo = multipathInfo;
    }
     ...
     */
    public com.vmware.converter.HostPlugStoreTopology getPlugStoreTopology() {
        return plugStoreTopology;
    }
     ...
     */
    public void setPlugStoreTopology(com.vmware.converter.HostPlugStoreTopology plugStoreTopology) {
        this.plugStoreTopology = plugStoreTopology;
    }
