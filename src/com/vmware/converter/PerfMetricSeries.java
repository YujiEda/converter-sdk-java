...
public class PerfMetricSeries  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.PerfMetricId id;

    public PerfMetricSeries() {
    }

    public PerfMetricSeries(
           com.vmware.converter.PerfMetricId id) {
        this.id = id;
    }
     ...
     * @return id
     */
    public com.vmware.converter.PerfMetricId getId() {
        return id;
    }
     ...
     * @param id
     */
    public void setId(com.vmware.converter.PerfMetricId id) {
        this.id = id;
    }
