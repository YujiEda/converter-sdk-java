...
public class DVSCapability  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.DistributedVirtualSwitchHostProductSpec[] compatibleHostComponentProductInfo;

    private com.vmware.converter.DVSFeatureCapability featuresSupported;
    ...
    public DVSCapability(
           ...
           com.vmware.converter.DistributedVirtualSwitchHostProductSpec[] compatibleHostComponentProductInfo,
           com.vmware.converter.DVSFeatureCapability featuresSupported) {
     ...
     */
    public com.vmware.converter.DistributedVirtualSwitchHostProductSpec[] getCompatibleHostComponentProductInfo() {
        return compatibleHostComponentProductInfo;
    }
     ...
     */
    public void setCompatibleHostComponentProductInfo(com.vmware.converter.DistributedVirtualSwitchHostProductSpec[] compatibleHostComponentProductInfo) {
        this.compatibleHostComponentProductInfo = compatibleHostComponentProductInfo;
    }

    public com.vmware.converter.DistributedVirtualSwitchHostProductSpec getCompatibleHostComponentProductInfo(int i) {
        return this.compatibleHostComponentProductInfo[i];
    }

    public void setCompatibleHostComponentProductInfo(int i, com.vmware.converter.DistributedVirtualSwitchHostProductSpec _value) {
        this.compatibleHostComponentProductInfo[i] = _value;
    }


    /**
     * Gets the featuresSupported value for this DVSCapability.
     * 
     * @return featuresSupported
     */
    public com.vmware.converter.DVSFeatureCapability getFeaturesSupported() {
        return featuresSupported;
    }


    /**
     * Sets the featuresSupported value for this DVSCapability.
     * 
     * @param featuresSupported
     */
    public void setFeaturesSupported(com.vmware.converter.DVSFeatureCapability featuresSupported) {
        this.featuresSupported = featuresSupported;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.featuresSupported==null && other.getFeaturesSupported()==null) || 
             (this.featuresSupported!=null &&
              this.featuresSupported.equals(other.getFeaturesSupported())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getFeaturesSupported() != null) {
            _hashCode += getFeaturesSupported().hashCode();
        }
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("featuresSupported");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "featuresSupported"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:vim25", "DVSFeatureCapability"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
