...
public class ProfileExecuteResult  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.ProfileDeferredPolicyOptionParameter[] requireInput;

    private com.vmware.converter.ProfileExecuteError[] error;
    ...
    public ProfileExecuteResult(
           ...
           com.vmware.converter.ProfileDeferredPolicyOptionParameter[] requireInput,
           com.vmware.converter.ProfileExecuteError[] error) {
        this.status = status;
     ...
     * @return requireInput
     */
    public com.vmware.converter.ProfileDeferredPolicyOptionParameter[] getRequireInput() {
        return requireInput;
    }
     ...
     * @param requireInput
     */
    public void setRequireInput(com.vmware.converter.ProfileDeferredPolicyOptionParameter[] requireInput) {
        this.requireInput = requireInput;
    }

    public com.vmware.converter.ProfileDeferredPolicyOptionParameter getRequireInput(int i) {
        return this.requireInput[i];
    }

    public void setRequireInput(int i, com.vmware.converter.ProfileDeferredPolicyOptionParameter _value) {
     ...
     * @return error
     */
    public com.vmware.converter.ProfileExecuteError[] getError() {
        return error;
    }
     ...
     * @param error
     */
    public void setError(com.vmware.converter.ProfileExecuteError[] error) {
        this.error = error;
    }

    public com.vmware.converter.ProfileExecuteError getError(int i) {
        return this.error[i];
    }

    public void setError(int i, com.vmware.converter.ProfileExecuteError _value) {
        this.error[i] = _value;
    }
