...
public class ArrayOfIpPool  implements java.io.Serializable {
    private com.vmware.converter.IpPool[] ipPool;

    public ArrayOfIpPool() {
    }

    public ArrayOfIpPool(
           com.vmware.converter.IpPool[] ipPool) {
           this.ipPool = ipPool;
    }
     ...
     * @return ipPool
     */
    public com.vmware.converter.IpPool[] getIpPool() {
        return ipPool;
    }
     ...
     * @param ipPool
     */
    public void setIpPool(com.vmware.converter.IpPool[] ipPool) {
        this.ipPool = ipPool;
    }

    public com.vmware.converter.IpPool getIpPool(int i) {
        return this.ipPool[i];
    }

    public void setIpPool(int i, com.vmware.converter.IpPool _value) {
