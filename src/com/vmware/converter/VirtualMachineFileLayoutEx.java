...
public class VirtualMachineFileLayoutEx  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] file;

    private com.vmware.converter.VirtualMachineFileLayoutExDiskLayout[] disk;

    private com.vmware.converter.VirtualMachineFileLayoutExSnapshotLayout[] snapshot;
    ...
    public VirtualMachineFileLayoutEx(
           com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] file,
           com.vmware.converter.VirtualMachineFileLayoutExDiskLayout[] disk,
           com.vmware.converter.VirtualMachineFileLayoutExSnapshotLayout[] snapshot,
     ...
     * @return file
     */
    public com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(com.vmware.converter.VirtualMachineFileLayoutExFileInfo[] file) {
        this.file = file;
    }

    public com.vmware.converter.VirtualMachineFileLayoutExFileInfo getFile(int i) {
        return this.file[i];
    }

    public void setFile(int i, com.vmware.converter.VirtualMachineFileLayoutExFileInfo _value) {
        this.file[i] = _value;
    }
     ...
     * @return snapshot
     */
    public com.vmware.converter.VirtualMachineFileLayoutExSnapshotLayout[] getSnapshot() {
        return snapshot;
    }
     ...
     * @param snapshot
     */
    public void setSnapshot(com.vmware.converter.VirtualMachineFileLayoutExSnapshotLayout[] snapshot) {
        this.snapshot = snapshot;
    }

    public com.vmware.converter.VirtualMachineFileLayoutExSnapshotLayout getSnapshot(int i) {
        return this.snapshot[i];
    }

    public void setSnapshot(int i, com.vmware.converter.VirtualMachineFileLayoutExSnapshotLayout _value) {
