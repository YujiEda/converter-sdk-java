...
public class TaskFilterSpec  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.TaskFilterSpecByEntity entity;

    private com.vmware.converter.TaskFilterSpecByTime time;

    private com.vmware.converter.TaskFilterSpecByUsername userName;

    private java.lang.String[] activationId;

    private com.vmware.converter.TaskInfoState[] state;
    ...
    public TaskFilterSpec(
           com.vmware.converter.TaskFilterSpecByEntity entity,
           com.vmware.converter.TaskFilterSpecByTime time,
           com.vmware.converter.TaskFilterSpecByUsername userName,
           java.lang.String[] activationId,
           com.vmware.converter.TaskInfoState[] state,
     ...
     * @return entity
     */
    public com.vmware.converter.TaskFilterSpecByEntity getEntity() {
        return entity;
    }
     ...
     * @param entity
     */
    public void setEntity(com.vmware.converter.TaskFilterSpecByEntity entity) {
        this.entity = entity;
    }
     ...
     * @return time
     */
    public com.vmware.converter.TaskFilterSpecByTime getTime() {
        return time;
    }
     ...
     * @param time
     */
    public void setTime(com.vmware.converter.TaskFilterSpecByTime time) {
        this.time = time;
    }
     ...
     * @return userName
     */
    public com.vmware.converter.TaskFilterSpecByUsername getUserName() {
        return userName;
    }
     ...
     * @param userName
     */
    public void setUserName(com.vmware.converter.TaskFilterSpecByUsername userName) {
        this.userName = userName;
    }


    /**
     * Gets the activationId value for this TaskFilterSpec.
     * 
     * @return activationId
     */
    ...
    /**
     * Sets the activationId value for this TaskFilterSpec.
     * 
     * @param activationId
     */
    ...
    public java.lang.String getActivationId(int i) {
        return this.activationId[i];
    }

    public void setActivationId(int i, java.lang.String _value) {
        this.activationId[i] = _value;
    }
     ...
     * @return state
     */
    public com.vmware.converter.TaskInfoState[] getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(com.vmware.converter.TaskInfoState[] state) {
        this.state = state;
    }

    public com.vmware.converter.TaskInfoState getState(int i) {
        return this.state[i];
    }

    public void setState(int i, com.vmware.converter.TaskInfoState _value) {
        this.state[i] = _value;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.activationId==null && other.getActivationId()==null) || 
             (this.activationId!=null &&
              java.util.Arrays.equals(this.activationId, other.getActivationId()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getActivationId() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getActivationId());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getActivationId(), i);
                if (obj != null &&
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "activationId"));
