...
public class EventFilterSpecByEntity  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ManagedObjectReference entity;

    private com.vmware.converter.EventFilterSpecRecursionOption recursion;
    ...
    public EventFilterSpecByEntity(
           ...
           com.vmware.converter.EventFilterSpecRecursionOption recursion) {
        this.entity = entity;
     ...
     * @return recursion
     */
    public com.vmware.converter.EventFilterSpecRecursionOption getRecursion() {
        return recursion;
    }
     ...
     * @param recursion
     */
    public void setRecursion(com.vmware.converter.EventFilterSpecRecursionOption recursion) {
        this.recursion = recursion;
    }
