...
public class ArrayOfVMwareDVSPvlanMapEntry  implements java.io.Serializable {
    private com.vmware.converter.VMwareDVSPvlanMapEntry[] VMwareDVSPvlanMapEntry;

    public ArrayOfVMwareDVSPvlanMapEntry() {
    }

    public ArrayOfVMwareDVSPvlanMapEntry(
           com.vmware.converter.VMwareDVSPvlanMapEntry[] VMwareDVSPvlanMapEntry) {
     ...
     */
    public com.vmware.converter.VMwareDVSPvlanMapEntry[] getVMwareDVSPvlanMapEntry() {
        return VMwareDVSPvlanMapEntry;
    }
     ...
     */
    public void setVMwareDVSPvlanMapEntry(com.vmware.converter.VMwareDVSPvlanMapEntry[] VMwareDVSPvlanMapEntry) {
        this.VMwareDVSPvlanMapEntry = VMwareDVSPvlanMapEntry;
    }

    public com.vmware.converter.VMwareDVSPvlanMapEntry getVMwareDVSPvlanMapEntry(int i) {
        return this.VMwareDVSPvlanMapEntry[i];
    }

    public void setVMwareDVSPvlanMapEntry(int i, com.vmware.converter.VMwareDVSPvlanMapEntry _value) {
