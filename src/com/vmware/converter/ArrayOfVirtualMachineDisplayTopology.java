...
public class ArrayOfVirtualMachineDisplayTopology  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineDisplayTopology[] virtualMachineDisplayTopology;

    public ArrayOfVirtualMachineDisplayTopology() {
    }

    public ArrayOfVirtualMachineDisplayTopology(
           com.vmware.converter.VirtualMachineDisplayTopology[] virtualMachineDisplayTopology) {
     ...
     */
    public com.vmware.converter.VirtualMachineDisplayTopology[] getVirtualMachineDisplayTopology() {
        return virtualMachineDisplayTopology;
    }
     ...
     */
    public void setVirtualMachineDisplayTopology(com.vmware.converter.VirtualMachineDisplayTopology[] virtualMachineDisplayTopology) {
        this.virtualMachineDisplayTopology = virtualMachineDisplayTopology;
    }

    public com.vmware.converter.VirtualMachineDisplayTopology getVirtualMachineDisplayTopology(int i) {
        return this.virtualMachineDisplayTopology[i];
    }

    public void setVirtualMachineDisplayTopology(int i, com.vmware.converter.VirtualMachineDisplayTopology _value) {
