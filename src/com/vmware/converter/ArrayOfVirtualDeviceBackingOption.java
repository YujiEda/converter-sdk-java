...
public class ArrayOfVirtualDeviceBackingOption  implements java.io.Serializable {
    private com.vmware.converter.VirtualDeviceBackingOption[] virtualDeviceBackingOption;

    public ArrayOfVirtualDeviceBackingOption() {
    }

    public ArrayOfVirtualDeviceBackingOption(
           com.vmware.converter.VirtualDeviceBackingOption[] virtualDeviceBackingOption) {
     ...
     */
    public com.vmware.converter.VirtualDeviceBackingOption[] getVirtualDeviceBackingOption() {
        return virtualDeviceBackingOption;
    }
     ...
     */
    public void setVirtualDeviceBackingOption(com.vmware.converter.VirtualDeviceBackingOption[] virtualDeviceBackingOption) {
        this.virtualDeviceBackingOption = virtualDeviceBackingOption;
    }

    public com.vmware.converter.VirtualDeviceBackingOption getVirtualDeviceBackingOption(int i) {
        return this.virtualDeviceBackingOption[i];
    }

    public void setVirtualDeviceBackingOption(int i, com.vmware.converter.VirtualDeviceBackingOption _value) {
