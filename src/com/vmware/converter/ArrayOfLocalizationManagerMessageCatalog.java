...
public class ArrayOfLocalizationManagerMessageCatalog  implements java.io.Serializable {
    private com.vmware.converter.LocalizationManagerMessageCatalog[] localizationManagerMessageCatalog;

    public ArrayOfLocalizationManagerMessageCatalog() {
    }

    public ArrayOfLocalizationManagerMessageCatalog(
           com.vmware.converter.LocalizationManagerMessageCatalog[] localizationManagerMessageCatalog) {
     ...
     */
    public com.vmware.converter.LocalizationManagerMessageCatalog[] getLocalizationManagerMessageCatalog() {
        return localizationManagerMessageCatalog;
    }
     ...
     */
    public void setLocalizationManagerMessageCatalog(com.vmware.converter.LocalizationManagerMessageCatalog[] localizationManagerMessageCatalog) {
        this.localizationManagerMessageCatalog = localizationManagerMessageCatalog;
    }

    public com.vmware.converter.LocalizationManagerMessageCatalog getLocalizationManagerMessageCatalog(int i) {
        return this.localizationManagerMessageCatalog[i];
    }

    public void setLocalizationManagerMessageCatalog(int i, com.vmware.converter.LocalizationManagerMessageCatalog _value) {
