...
public class ArrayOfHostIpRouteEntry  implements java.io.Serializable {
    private com.vmware.converter.HostIpRouteEntry[] hostIpRouteEntry;

    public ArrayOfHostIpRouteEntry() {
    }

    public ArrayOfHostIpRouteEntry(
           com.vmware.converter.HostIpRouteEntry[] hostIpRouteEntry) {
     ...
     */
    public com.vmware.converter.HostIpRouteEntry[] getHostIpRouteEntry() {
        return hostIpRouteEntry;
    }
     ...
     */
    public void setHostIpRouteEntry(com.vmware.converter.HostIpRouteEntry[] hostIpRouteEntry) {
        this.hostIpRouteEntry = hostIpRouteEntry;
    }

    public com.vmware.converter.HostIpRouteEntry getHostIpRouteEntry(int i) {
        return this.hostIpRouteEntry[i];
    }

    public void setHostIpRouteEntry(int i, com.vmware.converter.HostIpRouteEntry _value) {
