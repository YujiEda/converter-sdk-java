...
public class ArrayOfPermission  implements java.io.Serializable {
    private com.vmware.converter.Permission[] permission;

    public ArrayOfPermission() {
    }

    public ArrayOfPermission(
           com.vmware.converter.Permission[] permission) {
     ...
     * @return permission
     */
    public com.vmware.converter.Permission[] getPermission() {
        return permission;
    }
     ...
     * @param permission
     */
    public void setPermission(com.vmware.converter.Permission[] permission) {
        this.permission = permission;
    }

    public com.vmware.converter.Permission getPermission(int i) {
        return this.permission[i];
    }

    public void setPermission(int i, com.vmware.converter.Permission _value) {
