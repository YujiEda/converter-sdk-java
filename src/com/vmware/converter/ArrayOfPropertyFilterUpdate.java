...
public class ArrayOfPropertyFilterUpdate  implements java.io.Serializable {
    private com.vmware.converter.PropertyFilterUpdate[] propertyFilterUpdate;

    public ArrayOfPropertyFilterUpdate() {
    }

    public ArrayOfPropertyFilterUpdate(
           com.vmware.converter.PropertyFilterUpdate[] propertyFilterUpdate) {
     ...
     */
    public com.vmware.converter.PropertyFilterUpdate[] getPropertyFilterUpdate() {
        return propertyFilterUpdate;
    }
     ...
     */
    public void setPropertyFilterUpdate(com.vmware.converter.PropertyFilterUpdate[] propertyFilterUpdate) {
        this.propertyFilterUpdate = propertyFilterUpdate;
    }

    public com.vmware.converter.PropertyFilterUpdate getPropertyFilterUpdate(int i) {
        return this.propertyFilterUpdate[i];
    }

    public void setPropertyFilterUpdate(int i, com.vmware.converter.PropertyFilterUpdate _value) {
