...
public class GroupAlarmAction  extends com.vmware.converter.AlarmAction  implements java.io.Serializable {
    ...
    public com.vmware.converter.AlarmAction getAction(int i) {
        return this.action[i];
    }

    public void setAction(int i, com.vmware.converter.AlarmAction _value) {
