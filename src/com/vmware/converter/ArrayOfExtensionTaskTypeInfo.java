...
public class ArrayOfExtensionTaskTypeInfo  implements java.io.Serializable {
    private com.vmware.converter.ExtensionTaskTypeInfo[] extensionTaskTypeInfo;

    public ArrayOfExtensionTaskTypeInfo() {
    }

    public ArrayOfExtensionTaskTypeInfo(
           com.vmware.converter.ExtensionTaskTypeInfo[] extensionTaskTypeInfo) {
     ...
     */
    public com.vmware.converter.ExtensionTaskTypeInfo[] getExtensionTaskTypeInfo() {
        return extensionTaskTypeInfo;
    }
     ...
     */
    public void setExtensionTaskTypeInfo(com.vmware.converter.ExtensionTaskTypeInfo[] extensionTaskTypeInfo) {
        this.extensionTaskTypeInfo = extensionTaskTypeInfo;
    }

    public com.vmware.converter.ExtensionTaskTypeInfo getExtensionTaskTypeInfo(int i) {
        return this.extensionTaskTypeInfo[i];
    }

    public void setExtensionTaskTypeInfo(int i, com.vmware.converter.ExtensionTaskTypeInfo _value) {
