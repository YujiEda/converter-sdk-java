...
public class ClusterDrsRecommendation  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.ClusterDrsMigration[] migrationList;
    ...
    public ClusterDrsRecommendation(
           ...
           com.vmware.converter.ClusterDrsMigration[] migrationList) {
        this.key = key;
        this.rating = rating;
        this.reason = reason;
     ...
     */
    public com.vmware.converter.ClusterDrsMigration[] getMigrationList() {
        return migrationList;
    }
     ...
     * @param migrationList
     */
    public void setMigrationList(com.vmware.converter.ClusterDrsMigration[] migrationList) {
        this.migrationList = migrationList;
    }

    public com.vmware.converter.ClusterDrsMigration getMigrationList(int i) {
        return this.migrationList[i];
    }

    public void setMigrationList(int i, com.vmware.converter.ClusterDrsMigration _value) {
