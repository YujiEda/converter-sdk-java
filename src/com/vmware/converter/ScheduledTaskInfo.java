...
public class ScheduledTaskInfo  extends com.vmware.converter.ScheduledTaskSpec  implements java.io.Serializable {
    ...
    private com.vmware.converter.ManagedObjectReference taskObject;
    ...
    public ScheduledTaskInfo(
           ...
           boolean enabled,
           com.vmware.converter.TaskScheduler scheduler,
           ...
           com.vmware.converter.ManagedObjectReference taskObject) {
        super(
            name,
            description,
            enabled,
     ...
     * @return taskObject
     */
    public com.vmware.converter.ManagedObjectReference getTaskObject() {
        return taskObject;
    }
     ...
     * @param taskObject
     */
    public void setTaskObject(com.vmware.converter.ManagedObjectReference taskObject) {
        this.taskObject = taskObject;
    }
