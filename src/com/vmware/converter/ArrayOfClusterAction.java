...
public class ArrayOfClusterAction  implements java.io.Serializable {
    private com.vmware.converter.ClusterAction[] clusterAction;

    public ArrayOfClusterAction() {
    }

    public ArrayOfClusterAction(
           com.vmware.converter.ClusterAction[] clusterAction) {
     ...
     */
    public com.vmware.converter.ClusterAction[] getClusterAction() {
        return clusterAction;
    }
     ...
     * @param clusterAction
     */
    public void setClusterAction(com.vmware.converter.ClusterAction[] clusterAction) {
        this.clusterAction = clusterAction;
    }

    public com.vmware.converter.ClusterAction getClusterAction(int i) {
        return this.clusterAction[i];
    }

    public void setClusterAction(int i, com.vmware.converter.ClusterAction _value) {
