...
public class ArrayOfDistributedVirtualSwitchHostMemberConfigSpec  implements java.io.Serializable {
    private com.vmware.converter.DistributedVirtualSwitchHostMemberConfigSpec[] distributedVirtualSwitchHostMemberConfigSpec;

    public ArrayOfDistributedVirtualSwitchHostMemberConfigSpec() {
    }

    public ArrayOfDistributedVirtualSwitchHostMemberConfigSpec(
           com.vmware.converter.DistributedVirtualSwitchHostMemberConfigSpec[] distributedVirtualSwitchHostMemberConfigSpec) {
     ...
     */
    public com.vmware.converter.DistributedVirtualSwitchHostMemberConfigSpec[] getDistributedVirtualSwitchHostMemberConfigSpec() {
        return distributedVirtualSwitchHostMemberConfigSpec;
    }
     ...
     */
    public void setDistributedVirtualSwitchHostMemberConfigSpec(com.vmware.converter.DistributedVirtualSwitchHostMemberConfigSpec[] distributedVirtualSwitchHostMemberConfigSpec) {
        this.distributedVirtualSwitchHostMemberConfigSpec = distributedVirtualSwitchHostMemberConfigSpec;
    }

    public com.vmware.converter.DistributedVirtualSwitchHostMemberConfigSpec getDistributedVirtualSwitchHostMemberConfigSpec(int i) {
        return this.distributedVirtualSwitchHostMemberConfigSpec[i];
    }

    public void setDistributedVirtualSwitchHostMemberConfigSpec(int i, com.vmware.converter.DistributedVirtualSwitchHostMemberConfigSpec _value) {
