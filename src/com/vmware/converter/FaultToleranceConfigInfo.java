...
public class FaultToleranceConfigInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private int role;
    ...
    /**
     * Gets the orphaned value for this FaultToleranceConfigInfo.
     * 
     * @return orphaned
     */
    ...
    /**
     * Sets the orphaned value for this FaultToleranceConfigInfo.
     * 
     * @param orphaned
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "orphaned"));
