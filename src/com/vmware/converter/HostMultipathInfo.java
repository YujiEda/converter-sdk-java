...
public class HostMultipathInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostMultipathInfoLogicalUnit[] lun;

    public HostMultipathInfo() {
    }

    public HostMultipathInfo(
           com.vmware.converter.HostMultipathInfoLogicalUnit[] lun) {
        this.lun = lun;
    }
     ...
     * @return lun
     */
    public com.vmware.converter.HostMultipathInfoLogicalUnit[] getLun() {
        return lun;
    }
     ...
     * @param lun
     */
    public void setLun(com.vmware.converter.HostMultipathInfoLogicalUnit[] lun) {
        this.lun = lun;
    }

    public com.vmware.converter.HostMultipathInfoLogicalUnit getLun(int i) {
        return this.lun[i];
    }

    public void setLun(int i, com.vmware.converter.HostMultipathInfoLogicalUnit _value) {
        this.lun[i] = _value;
    }
