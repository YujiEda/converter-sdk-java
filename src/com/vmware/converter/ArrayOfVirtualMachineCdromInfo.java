...
public class ArrayOfVirtualMachineCdromInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineCdromInfo[] virtualMachineCdromInfo;

    public ArrayOfVirtualMachineCdromInfo() {
    }

    public ArrayOfVirtualMachineCdromInfo(
           com.vmware.converter.VirtualMachineCdromInfo[] virtualMachineCdromInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachineCdromInfo[] getVirtualMachineCdromInfo() {
        return virtualMachineCdromInfo;
    }
     ...
     */
    public void setVirtualMachineCdromInfo(com.vmware.converter.VirtualMachineCdromInfo[] virtualMachineCdromInfo) {
        this.virtualMachineCdromInfo = virtualMachineCdromInfo;
    }

    public com.vmware.converter.VirtualMachineCdromInfo getVirtualMachineCdromInfo(int i) {
        return this.virtualMachineCdromInfo[i];
    }

    public void setVirtualMachineCdromInfo(int i, com.vmware.converter.VirtualMachineCdromInfo _value) {
