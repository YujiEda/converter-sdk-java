...
public class HostStorageElementInfo  extends com.vmware.converter.HostHardwareElementInfo  implements java.io.Serializable {
    private com.vmware.converter.HostStorageOperationalInfo[] operationalInfo;
    ...
    public HostStorageElementInfo(
           ...
           com.vmware.converter.ElementDescription status,
           com.vmware.converter.HostStorageOperationalInfo[] operationalInfo) {
        super(
            name,
            status);
     ...
     */
    public com.vmware.converter.HostStorageOperationalInfo[] getOperationalInfo() {
        return operationalInfo;
    }
     ...
     */
    public void setOperationalInfo(com.vmware.converter.HostStorageOperationalInfo[] operationalInfo) {
        this.operationalInfo = operationalInfo;
    }

    public com.vmware.converter.HostStorageOperationalInfo getOperationalInfo(int i) {
        return this.operationalInfo[i];
    }

    public void setOperationalInfo(int i, com.vmware.converter.HostStorageOperationalInfo _value) {
