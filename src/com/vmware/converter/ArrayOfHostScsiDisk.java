...
public class ArrayOfHostScsiDisk  implements java.io.Serializable {
    private com.vmware.converter.HostScsiDisk[] hostScsiDisk;

    public ArrayOfHostScsiDisk() {
    }

    public ArrayOfHostScsiDisk(
           com.vmware.converter.HostScsiDisk[] hostScsiDisk) {
     ...
     * @return hostScsiDisk
     */
    public com.vmware.converter.HostScsiDisk[] getHostScsiDisk() {
        return hostScsiDisk;
    }
     ...
     * @param hostScsiDisk
     */
    public void setHostScsiDisk(com.vmware.converter.HostScsiDisk[] hostScsiDisk) {
        this.hostScsiDisk = hostScsiDisk;
    }

    public com.vmware.converter.HostScsiDisk getHostScsiDisk(int i) {
        return this.hostScsiDisk[i];
    }

    public void setHostScsiDisk(int i, com.vmware.converter.HostScsiDisk _value) {
