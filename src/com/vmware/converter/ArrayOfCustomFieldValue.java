...
public class ArrayOfCustomFieldValue  implements java.io.Serializable {
    private com.vmware.converter.CustomFieldValue[] customFieldValue;

    public ArrayOfCustomFieldValue() {
    }

    public ArrayOfCustomFieldValue(
           com.vmware.converter.CustomFieldValue[] customFieldValue) {
     ...
     */
    public com.vmware.converter.CustomFieldValue[] getCustomFieldValue() {
        return customFieldValue;
    }
     ...
     */
    public void setCustomFieldValue(com.vmware.converter.CustomFieldValue[] customFieldValue) {
        this.customFieldValue = customFieldValue;
    }

    public com.vmware.converter.CustomFieldValue getCustomFieldValue(int i) {
        return this.customFieldValue[i];
    }

    public void setCustomFieldValue(int i, com.vmware.converter.CustomFieldValue _value) {
