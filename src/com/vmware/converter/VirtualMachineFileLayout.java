...
public class VirtualMachineFileLayout  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private java.lang.String[] configFile;

    private java.lang.String[] logFile;

    private com.vmware.converter.VirtualMachineFileLayoutDiskLayout[] disk;

    private com.vmware.converter.VirtualMachineFileLayoutSnapshotLayout[] snapshot;
    ...
    public VirtualMachineFileLayout(
           ...
           com.vmware.converter.VirtualMachineFileLayoutDiskLayout[] disk,
           com.vmware.converter.VirtualMachineFileLayoutSnapshotLayout[] snapshot,
     ...
     * @return disk
     */
    public com.vmware.converter.VirtualMachineFileLayoutDiskLayout[] getDisk() {
        return disk;
    }
     ...
     * @param disk
     */
    public void setDisk(com.vmware.converter.VirtualMachineFileLayoutDiskLayout[] disk) {
        this.disk = disk;
    }

    public com.vmware.converter.VirtualMachineFileLayoutDiskLayout getDisk(int i) {
        return this.disk[i];
    }

    public void setDisk(int i, com.vmware.converter.VirtualMachineFileLayoutDiskLayout _value) {
        this.disk[i] = _value;
    }
     ...
     * @return snapshot
     */
    public com.vmware.converter.VirtualMachineFileLayoutSnapshotLayout[] getSnapshot() {
        return snapshot;
    }
     ...
     * @param snapshot
     */
    public void setSnapshot(com.vmware.converter.VirtualMachineFileLayoutSnapshotLayout[] snapshot) {
        this.snapshot = snapshot;
    }

    public com.vmware.converter.VirtualMachineFileLayoutSnapshotLayout getSnapshot(int i) {
        return this.snapshot[i];
    }

    public void setSnapshot(int i, com.vmware.converter.VirtualMachineFileLayoutSnapshotLayout _value) {
