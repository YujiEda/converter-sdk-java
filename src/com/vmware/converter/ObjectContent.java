...
public class ObjectContent  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ManagedObjectReference obj;

    private com.vmware.converter.DynamicProperty[] propSet;
    ...
    public ObjectContent(
           ...
           com.vmware.converter.DynamicProperty[] propSet,
     ...
     * @return propSet
     */
    public com.vmware.converter.DynamicProperty[] getPropSet() {
        return propSet;
    }
     ...
     * @param propSet
     */
    public void setPropSet(com.vmware.converter.DynamicProperty[] propSet) {
        this.propSet = propSet;
    }

    public com.vmware.converter.DynamicProperty getPropSet(int i) {
        return this.propSet[i];
    }

    public void setPropSet(int i, com.vmware.converter.DynamicProperty _value) {
