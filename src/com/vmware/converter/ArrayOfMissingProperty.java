...
public class ArrayOfMissingProperty  implements java.io.Serializable {
    private com.vmware.converter.MissingProperty[] missingProperty;

    public ArrayOfMissingProperty() {
    }

    public ArrayOfMissingProperty(
           com.vmware.converter.MissingProperty[] missingProperty) {
     ...
     */
    public com.vmware.converter.MissingProperty[] getMissingProperty() {
        return missingProperty;
    }
     ...
     */
    public void setMissingProperty(com.vmware.converter.MissingProperty[] missingProperty) {
        this.missingProperty = missingProperty;
    }

    public com.vmware.converter.MissingProperty getMissingProperty(int i) {
        return this.missingProperty[i];
    }

    public void setMissingProperty(int i, com.vmware.converter.MissingProperty _value) {
