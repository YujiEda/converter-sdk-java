...
public class ArrayOfEventAlarmExpressionComparison  implements java.io.Serializable {
    private com.vmware.converter.EventAlarmExpressionComparison[] eventAlarmExpressionComparison;

    public ArrayOfEventAlarmExpressionComparison() {
    }

    public ArrayOfEventAlarmExpressionComparison(
           com.vmware.converter.EventAlarmExpressionComparison[] eventAlarmExpressionComparison) {
     ...
     */
    public com.vmware.converter.EventAlarmExpressionComparison[] getEventAlarmExpressionComparison() {
        return eventAlarmExpressionComparison;
    }
     ...
     */
    public void setEventAlarmExpressionComparison(com.vmware.converter.EventAlarmExpressionComparison[] eventAlarmExpressionComparison) {
        this.eventAlarmExpressionComparison = eventAlarmExpressionComparison;
    }

    public com.vmware.converter.EventAlarmExpressionComparison getEventAlarmExpressionComparison(int i) {
        return this.eventAlarmExpressionComparison[i];
    }

    public void setEventAlarmExpressionComparison(int i, com.vmware.converter.EventAlarmExpressionComparison _value) {
