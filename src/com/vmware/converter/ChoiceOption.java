...
public class ChoiceOption  extends com.vmware.converter.OptionType  implements java.io.Serializable {
    private com.vmware.converter.ElementDescription[] choiceInfo;
    ...
    public ChoiceOption(
           ...
           com.vmware.converter.ElementDescription[] choiceInfo,
     ...
     * @return choiceInfo
     */
    public com.vmware.converter.ElementDescription[] getChoiceInfo() {
        return choiceInfo;
    }
     ...
     * @param choiceInfo
     */
    public void setChoiceInfo(com.vmware.converter.ElementDescription[] choiceInfo) {
        this.choiceInfo = choiceInfo;
    }

    public com.vmware.converter.ElementDescription getChoiceInfo(int i) {
        return this.choiceInfo[i];
    }

    public void setChoiceInfo(int i, com.vmware.converter.ElementDescription _value) {
