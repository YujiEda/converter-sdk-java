...
public class HostDiskPartitionBlockRange  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private java.lang.Integer partition;

    private java.lang.String type;

    private com.vmware.converter.HostDiskDimensionsLba start;

    private com.vmware.converter.HostDiskDimensionsLba end;
    ...
    public HostDiskPartitionBlockRange(
           ...
           com.vmware.converter.HostDiskDimensionsLba start,
           com.vmware.converter.HostDiskDimensionsLba end) {
     ...
     * @return start
     */
    public com.vmware.converter.HostDiskDimensionsLba getStart() {
        return start;
    }
     ...
     * @param start
     */
    public void setStart(com.vmware.converter.HostDiskDimensionsLba start) {
        this.start = start;
    }
     ...
     * @return end
     */
    public com.vmware.converter.HostDiskDimensionsLba getEnd() {
        return end;
    }
     ...
     * @param end
     */
    public void setEnd(com.vmware.converter.HostDiskDimensionsLba end) {
        this.end = end;
    }
