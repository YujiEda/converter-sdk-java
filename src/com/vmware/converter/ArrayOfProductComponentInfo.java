...
public class ArrayOfProductComponentInfo  implements java.io.Serializable {
    private com.vmware.converter.ProductComponentInfo[] productComponentInfo;

    public ArrayOfProductComponentInfo() {
    }

    public ArrayOfProductComponentInfo(
           com.vmware.converter.ProductComponentInfo[] productComponentInfo) {
     ...
     */
    public com.vmware.converter.ProductComponentInfo[] getProductComponentInfo() {
        return productComponentInfo;
    }
     ...
     */
    public void setProductComponentInfo(com.vmware.converter.ProductComponentInfo[] productComponentInfo) {
        this.productComponentInfo = productComponentInfo;
    }

    public com.vmware.converter.ProductComponentInfo getProductComponentInfo(int i) {
        return this.productComponentInfo[i];
    }

    public void setProductComponentInfo(int i, com.vmware.converter.ProductComponentInfo _value) {
