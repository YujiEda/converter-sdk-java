...
public class PerfEntityMetricCSV  extends com.vmware.converter.PerfEntityMetricBase  implements java.io.Serializable {
    private java.lang.String sampleInfoCSV;

    private com.vmware.converter.PerfMetricSeriesCSV[] value;
    ...
    public PerfEntityMetricCSV(
           ...
           com.vmware.converter.PerfMetricSeriesCSV[] value) {
        super(
            entity);
     ...
     * @return value
     */
    public com.vmware.converter.PerfMetricSeriesCSV[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.vmware.converter.PerfMetricSeriesCSV[] value) {
        this.value = value;
    }

    public com.vmware.converter.PerfMetricSeriesCSV getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.vmware.converter.PerfMetricSeriesCSV _value) {
        this.value[i] = _value;
    }
