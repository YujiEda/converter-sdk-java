...
public class ArrayOfPerfMetricId  implements java.io.Serializable {
    private com.vmware.converter.PerfMetricId[] perfMetricId;

    public ArrayOfPerfMetricId() {
    }

    public ArrayOfPerfMetricId(
           com.vmware.converter.PerfMetricId[] perfMetricId) {
     ...
     * @return perfMetricId
     */
    public com.vmware.converter.PerfMetricId[] getPerfMetricId() {
        return perfMetricId;
    }
     ...
     * @param perfMetricId
     */
    public void setPerfMetricId(com.vmware.converter.PerfMetricId[] perfMetricId) {
        this.perfMetricId = perfMetricId;
    }

    public com.vmware.converter.PerfMetricId getPerfMetricId(int i) {
        return this.perfMetricId[i];
    }

    public void setPerfMetricId(int i, com.vmware.converter.PerfMetricId _value) {
