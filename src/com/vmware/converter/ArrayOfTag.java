...
public class ArrayOfTag  implements java.io.Serializable {
    private com.vmware.converter.Tag[] tag;

    public ArrayOfTag() {
    }

    public ArrayOfTag(
           com.vmware.converter.Tag[] tag) {
           this.tag = tag;
    }
     ...
     * @return tag
     */
    public com.vmware.converter.Tag[] getTag() {
        return tag;
    }
     ...
     * @param tag
     */
    public void setTag(com.vmware.converter.Tag[] tag) {
        this.tag = tag;
    }

    public com.vmware.converter.Tag getTag(int i) {
        return this.tag[i];
    }

    public void setTag(int i, com.vmware.converter.Tag _value) {
        this.tag[i] = _value;
    }
