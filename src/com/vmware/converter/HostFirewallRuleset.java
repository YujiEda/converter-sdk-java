...
public class HostFirewallRuleset  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.HostFirewallRule[] rule;
    ...
    public HostFirewallRuleset(
           ...
           boolean required,
           com.vmware.converter.HostFirewallRule[] rule,
     ...
     * @return rule
     */
    public com.vmware.converter.HostFirewallRule[] getRule() {
        return rule;
    }
     ...
     * @param rule
     */
    public void setRule(com.vmware.converter.HostFirewallRule[] rule) {
        this.rule = rule;
    }

    public com.vmware.converter.HostFirewallRule getRule(int i) {
        return this.rule[i];
    }

    public void setRule(int i, com.vmware.converter.HostFirewallRule _value) {
        this.rule[i] = _value;
    }
    ...
    /**
     * Gets the allowedHosts value for this HostFirewallRuleset.
     * 
     * @return allowedHosts
     */
    ...
    /**
     * Sets the allowedHosts value for this HostFirewallRuleset.
     * 
     * @param allowedHosts
     */
