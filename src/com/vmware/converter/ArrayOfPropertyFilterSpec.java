...
public class ArrayOfPropertyFilterSpec  implements java.io.Serializable {
    private com.vmware.converter.PropertyFilterSpec[] propertyFilterSpec;

    public ArrayOfPropertyFilterSpec() {
    }

    public ArrayOfPropertyFilterSpec(
           com.vmware.converter.PropertyFilterSpec[] propertyFilterSpec) {
     ...
     */
    public com.vmware.converter.PropertyFilterSpec[] getPropertyFilterSpec() {
        return propertyFilterSpec;
    }
     ...
     */
    public void setPropertyFilterSpec(com.vmware.converter.PropertyFilterSpec[] propertyFilterSpec) {
        this.propertyFilterSpec = propertyFilterSpec;
    }

    public com.vmware.converter.PropertyFilterSpec getPropertyFilterSpec(int i) {
        return this.propertyFilterSpec[i];
    }

    public void setPropertyFilterSpec(int i, com.vmware.converter.PropertyFilterSpec _value) {
