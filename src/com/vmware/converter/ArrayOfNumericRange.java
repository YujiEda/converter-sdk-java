...
public class ArrayOfNumericRange  implements java.io.Serializable {
    private com.vmware.converter.NumericRange[] numericRange;

    public ArrayOfNumericRange() {
    }

    public ArrayOfNumericRange(
           com.vmware.converter.NumericRange[] numericRange) {
     ...
     * @return numericRange
     */
    public com.vmware.converter.NumericRange[] getNumericRange() {
        return numericRange;
    }
     ...
     * @param numericRange
     */
    public void setNumericRange(com.vmware.converter.NumericRange[] numericRange) {
        this.numericRange = numericRange;
    }

    public com.vmware.converter.NumericRange getNumericRange(int i) {
        return this.numericRange[i];
    }

    public void setNumericRange(int i, com.vmware.converter.NumericRange _value) {
