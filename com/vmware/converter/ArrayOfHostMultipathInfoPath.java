...
public class ArrayOfHostMultipathInfoPath  implements java.io.Serializable {
    private com.vmware.converter.HostMultipathInfoPath[] hostMultipathInfoPath;

    public ArrayOfHostMultipathInfoPath() {
    }

    public ArrayOfHostMultipathInfoPath(
           com.vmware.converter.HostMultipathInfoPath[] hostMultipathInfoPath) {
     ...
     */
    public com.vmware.converter.HostMultipathInfoPath[] getHostMultipathInfoPath() {
        return hostMultipathInfoPath;
    }
     ...
     */
    public void setHostMultipathInfoPath(com.vmware.converter.HostMultipathInfoPath[] hostMultipathInfoPath) {
        this.hostMultipathInfoPath = hostMultipathInfoPath;
    }

    public com.vmware.converter.HostMultipathInfoPath getHostMultipathInfoPath(int i) {
        return this.hostMultipathInfoPath[i];
    }

    public void setHostMultipathInfoPath(int i, com.vmware.converter.HostMultipathInfoPath _value) {
