...
public class VmfsDatastoreMultipleExtentOption  extends com.vmware.converter.VmfsDatastoreBaseOption  implements java.io.Serializable {
    private com.vmware.converter.HostDiskPartitionBlockRange[] vmfsExtent;
    ...
    public VmfsDatastoreMultipleExtentOption(
           ...
           com.vmware.converter.HostDiskPartitionBlockRange[] vmfsExtent) {
        super(
            layout,
     ...
     * @return vmfsExtent
     */
    public com.vmware.converter.HostDiskPartitionBlockRange[] getVmfsExtent() {
        return vmfsExtent;
    }
     ...
     * @param vmfsExtent
     */
    public void setVmfsExtent(com.vmware.converter.HostDiskPartitionBlockRange[] vmfsExtent) {
        this.vmfsExtent = vmfsExtent;
    }

    public com.vmware.converter.HostDiskPartitionBlockRange getVmfsExtent(int i) {
        return this.vmfsExtent[i];
    }

    public void setVmfsExtent(int i, com.vmware.converter.HostDiskPartitionBlockRange _value) {
