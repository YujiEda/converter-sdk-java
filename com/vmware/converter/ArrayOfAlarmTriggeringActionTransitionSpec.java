...
public class ArrayOfAlarmTriggeringActionTransitionSpec  implements java.io.Serializable {
    private com.vmware.converter.AlarmTriggeringActionTransitionSpec[] alarmTriggeringActionTransitionSpec;

    public ArrayOfAlarmTriggeringActionTransitionSpec() {
    }

    public ArrayOfAlarmTriggeringActionTransitionSpec(
           com.vmware.converter.AlarmTriggeringActionTransitionSpec[] alarmTriggeringActionTransitionSpec) {
     ...
     */
    public com.vmware.converter.AlarmTriggeringActionTransitionSpec[] getAlarmTriggeringActionTransitionSpec() {
        return alarmTriggeringActionTransitionSpec;
    }
     ...
     */
    public void setAlarmTriggeringActionTransitionSpec(com.vmware.converter.AlarmTriggeringActionTransitionSpec[] alarmTriggeringActionTransitionSpec) {
        this.alarmTriggeringActionTransitionSpec = alarmTriggeringActionTransitionSpec;
    }

    public com.vmware.converter.AlarmTriggeringActionTransitionSpec getAlarmTriggeringActionTransitionSpec(int i) {
        return this.alarmTriggeringActionTransitionSpec[i];
    }

    public void setAlarmTriggeringActionTransitionSpec(int i, com.vmware.converter.AlarmTriggeringActionTransitionSpec _value) {
