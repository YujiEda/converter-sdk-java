...
public class ArrayOfHostVirtualNic  implements java.io.Serializable {
    private com.vmware.converter.HostVirtualNic[] hostVirtualNic;

    public ArrayOfHostVirtualNic() {
    }

    public ArrayOfHostVirtualNic(
           com.vmware.converter.HostVirtualNic[] hostVirtualNic) {
     ...
     */
    public com.vmware.converter.HostVirtualNic[] getHostVirtualNic() {
        return hostVirtualNic;
    }
     ...
     */
    public void setHostVirtualNic(com.vmware.converter.HostVirtualNic[] hostVirtualNic) {
        this.hostVirtualNic = hostVirtualNic;
    }

    public com.vmware.converter.HostVirtualNic getHostVirtualNic(int i) {
        return this.hostVirtualNic[i];
    }

    public void setHostVirtualNic(int i, com.vmware.converter.HostVirtualNic _value) {
