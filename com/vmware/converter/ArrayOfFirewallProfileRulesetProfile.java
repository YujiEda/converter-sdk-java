...
public class ArrayOfFirewallProfileRulesetProfile  implements java.io.Serializable {
    private com.vmware.converter.FirewallProfileRulesetProfile[] firewallProfileRulesetProfile;

    public ArrayOfFirewallProfileRulesetProfile() {
    }

    public ArrayOfFirewallProfileRulesetProfile(
           com.vmware.converter.FirewallProfileRulesetProfile[] firewallProfileRulesetProfile) {
     ...
     */
    public com.vmware.converter.FirewallProfileRulesetProfile[] getFirewallProfileRulesetProfile() {
        return firewallProfileRulesetProfile;
    }
     ...
     */
    public void setFirewallProfileRulesetProfile(com.vmware.converter.FirewallProfileRulesetProfile[] firewallProfileRulesetProfile) {
        this.firewallProfileRulesetProfile = firewallProfileRulesetProfile;
    }

    public com.vmware.converter.FirewallProfileRulesetProfile getFirewallProfileRulesetProfile(int i) {
        return this.firewallProfileRulesetProfile[i];
    }

    public void setFirewallProfileRulesetProfile(int i, com.vmware.converter.FirewallProfileRulesetProfile _value) {
