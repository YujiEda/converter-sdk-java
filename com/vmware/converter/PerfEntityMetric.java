...
public class PerfEntityMetric  extends com.vmware.converter.PerfEntityMetricBase  implements java.io.Serializable {
    private com.vmware.converter.PerfSampleInfo[] sampleInfo;

    private com.vmware.converter.PerfMetricSeries[] value;
    ...
    public PerfEntityMetric(
           ...
           com.vmware.converter.PerfSampleInfo[] sampleInfo,
           com.vmware.converter.PerfMetricSeries[] value) {
        super(
            entity);
     ...
     * @return sampleInfo
     */
    public com.vmware.converter.PerfSampleInfo[] getSampleInfo() {
        return sampleInfo;
    }
     ...
     * @param sampleInfo
     */
    public void setSampleInfo(com.vmware.converter.PerfSampleInfo[] sampleInfo) {
        this.sampleInfo = sampleInfo;
    }

    public com.vmware.converter.PerfSampleInfo getSampleInfo(int i) {
        return this.sampleInfo[i];
    }

    public void setSampleInfo(int i, com.vmware.converter.PerfSampleInfo _value) {
     ...
     * @return value
     */
    public com.vmware.converter.PerfMetricSeries[] getValue() {
        return value;
    }
     ...
     * @param value
     */
    public void setValue(com.vmware.converter.PerfMetricSeries[] value) {
        this.value = value;
    }

    public com.vmware.converter.PerfMetricSeries getValue(int i) {
        return this.value[i];
    }

    public void setValue(int i, com.vmware.converter.PerfMetricSeries _value) {
        this.value[i] = _value;
    }
