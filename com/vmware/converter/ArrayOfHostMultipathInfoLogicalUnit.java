...
public class ArrayOfHostMultipathInfoLogicalUnit  implements java.io.Serializable {
    private com.vmware.converter.HostMultipathInfoLogicalUnit[] hostMultipathInfoLogicalUnit;

    public ArrayOfHostMultipathInfoLogicalUnit() {
    }

    public ArrayOfHostMultipathInfoLogicalUnit(
           com.vmware.converter.HostMultipathInfoLogicalUnit[] hostMultipathInfoLogicalUnit) {
     ...
     */
    public com.vmware.converter.HostMultipathInfoLogicalUnit[] getHostMultipathInfoLogicalUnit() {
        return hostMultipathInfoLogicalUnit;
    }
     ...
     */
    public void setHostMultipathInfoLogicalUnit(com.vmware.converter.HostMultipathInfoLogicalUnit[] hostMultipathInfoLogicalUnit) {
        this.hostMultipathInfoLogicalUnit = hostMultipathInfoLogicalUnit;
    }

    public com.vmware.converter.HostMultipathInfoLogicalUnit getHostMultipathInfoLogicalUnit(int i) {
        return this.hostMultipathInfoLogicalUnit[i];
    }

    public void setHostMultipathInfoLogicalUnit(int i, com.vmware.converter.HostMultipathInfoLogicalUnit _value) {
