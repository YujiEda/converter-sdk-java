...
public class CustomizationSpec  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.CustomizationOptions options;

    private com.vmware.converter.CustomizationIdentitySettings identity;

    private com.vmware.converter.CustomizationGlobalIPSettings globalIPSettings;

    private com.vmware.converter.CustomizationAdapterMapping[] nicSettingMap;
    ...
    public CustomizationSpec(
           com.vmware.converter.CustomizationOptions options,
           com.vmware.converter.CustomizationIdentitySettings identity,
           com.vmware.converter.CustomizationGlobalIPSettings globalIPSettings,
           com.vmware.converter.CustomizationAdapterMapping[] nicSettingMap,
           byte[] encryptionKey) {
     ...
     * @return options
     */
    public com.vmware.converter.CustomizationOptions getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.vmware.converter.CustomizationOptions options) {
        this.options = options;
    }
     ...
     * @return identity
     */
    public com.vmware.converter.CustomizationIdentitySettings getIdentity() {
        return identity;
    }
     ...
     * @param identity
     */
    public void setIdentity(com.vmware.converter.CustomizationIdentitySettings identity) {
        this.identity = identity;
    }
     ...
     */
    public com.vmware.converter.CustomizationGlobalIPSettings getGlobalIPSettings() {
        return globalIPSettings;
    }
     ...
     */
    public void setGlobalIPSettings(com.vmware.converter.CustomizationGlobalIPSettings globalIPSettings) {
        this.globalIPSettings = globalIPSettings;
    }
     ...
     */
    public com.vmware.converter.CustomizationAdapterMapping[] getNicSettingMap() {
        return nicSettingMap;
    }
     ...
     * @param nicSettingMap
     */
    public void setNicSettingMap(com.vmware.converter.CustomizationAdapterMapping[] nicSettingMap) {
        this.nicSettingMap = nicSettingMap;
    }

    public com.vmware.converter.CustomizationAdapterMapping getNicSettingMap(int i) {
        return this.nicSettingMap[i];
    }

    public void setNicSettingMap(int i, com.vmware.converter.CustomizationAdapterMapping _value) {
