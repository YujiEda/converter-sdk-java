...
public class ArrayOfHostMultipathStateInfoPath  implements java.io.Serializable {
    private com.vmware.converter.HostMultipathStateInfoPath[] hostMultipathStateInfoPath;

    public ArrayOfHostMultipathStateInfoPath() {
    }

    public ArrayOfHostMultipathStateInfoPath(
           com.vmware.converter.HostMultipathStateInfoPath[] hostMultipathStateInfoPath) {
     ...
     */
    public com.vmware.converter.HostMultipathStateInfoPath[] getHostMultipathStateInfoPath() {
        return hostMultipathStateInfoPath;
    }
     ...
     */
    public void setHostMultipathStateInfoPath(com.vmware.converter.HostMultipathStateInfoPath[] hostMultipathStateInfoPath) {
        this.hostMultipathStateInfoPath = hostMultipathStateInfoPath;
    }

    public com.vmware.converter.HostMultipathStateInfoPath getHostMultipathStateInfoPath(int i) {
        return this.hostMultipathStateInfoPath[i];
    }

    public void setHostMultipathStateInfoPath(int i, com.vmware.converter.HostMultipathStateInfoPath _value) {
