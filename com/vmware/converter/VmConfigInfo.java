...
public class VmConfigInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.VAppOvfSectionInfo[] ovfSection;
    ...
    public com.vmware.converter.VAppProductInfo getProduct(int i) {
        return this.product[i];
    }

    public void setProduct(int i, com.vmware.converter.VAppProductInfo _value) {
     ...
     * @return ovfSection
     */
    public com.vmware.converter.VAppOvfSectionInfo[] getOvfSection() {
        return ovfSection;
    }
     ...
     * @param ovfSection
     */
    public void setOvfSection(com.vmware.converter.VAppOvfSectionInfo[] ovfSection) {
        this.ovfSection = ovfSection;
    }

    public com.vmware.converter.VAppOvfSectionInfo getOvfSection(int i) {
        return this.ovfSection[i];
    }

    public void setOvfSection(int i, com.vmware.converter.VAppOvfSectionInfo _value) {
