...
public class ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots  implements java.io.Serializable {
    private com.vmware.converter.ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots[] clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots;

    public ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots() {
    }

    public ArrayOfClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots(
           com.vmware.converter.ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots[] clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots) {
     ...
     */
    public com.vmware.converter.ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots[] getClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots() {
        return clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots;
    }
     ...
     */
    public void setClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots(com.vmware.converter.ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots[] clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots) {
        this.clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots = clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots;
    }

    public com.vmware.converter.ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots getClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots(int i) {
        return this.clusterDasFailoverLevelAdvancedRuntimeInfoHostSlots[i];
    }

    public void setClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots(int i, com.vmware.converter.ClusterDasFailoverLevelAdvancedRuntimeInfoHostSlots _value) {
