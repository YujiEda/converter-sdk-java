...
public class ArrayOfDvsProfile  implements java.io.Serializable {
    private com.vmware.converter.DvsProfile[] dvsProfile;

    public ArrayOfDvsProfile() {
    }

    public ArrayOfDvsProfile(
           com.vmware.converter.DvsProfile[] dvsProfile) {
     ...
     * @return dvsProfile
     */
    public com.vmware.converter.DvsProfile[] getDvsProfile() {
        return dvsProfile;
    }
     ...
     * @param dvsProfile
     */
    public void setDvsProfile(com.vmware.converter.DvsProfile[] dvsProfile) {
        this.dvsProfile = dvsProfile;
    }

    public com.vmware.converter.DvsProfile getDvsProfile(int i) {
        return this.dvsProfile[i];
    }

    public void setDvsProfile(int i, com.vmware.converter.DvsProfile _value) {
