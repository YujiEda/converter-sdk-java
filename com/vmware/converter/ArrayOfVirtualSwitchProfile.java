...
public class ArrayOfVirtualSwitchProfile  implements java.io.Serializable {
    private com.vmware.converter.VirtualSwitchProfile[] virtualSwitchProfile;

    public ArrayOfVirtualSwitchProfile() {
    }

    public ArrayOfVirtualSwitchProfile(
           com.vmware.converter.VirtualSwitchProfile[] virtualSwitchProfile) {
     ...
     */
    public com.vmware.converter.VirtualSwitchProfile[] getVirtualSwitchProfile() {
        return virtualSwitchProfile;
    }
     ...
     */
    public void setVirtualSwitchProfile(com.vmware.converter.VirtualSwitchProfile[] virtualSwitchProfile) {
        this.virtualSwitchProfile = virtualSwitchProfile;
    }

    public com.vmware.converter.VirtualSwitchProfile getVirtualSwitchProfile(int i) {
        return this.virtualSwitchProfile[i];
    }

    public void setVirtualSwitchProfile(int i, com.vmware.converter.VirtualSwitchProfile _value) {
