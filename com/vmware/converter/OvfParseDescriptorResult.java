...
public class OvfParseDescriptorResult  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private java.lang.String[] eula;

    private com.vmware.converter.OvfNetworkInfo[] network;

    private java.lang.String[] ipAllocationScheme;

    private java.lang.String[] ipProtocols;

    private com.vmware.converter.VAppPropertyInfo[] property;

    private com.vmware.converter.VAppProductInfo productInfo;
    ...
    private com.vmware.converter.OvfDeploymentOption[] deploymentOption;

    private java.lang.String defaultDeploymentOption;

    private com.vmware.converter.KeyValue[] entityName;

    private com.vmware.converter.OvfConsumerOstNode annotatedOst;
    ...
    public OvfParseDescriptorResult(
           ...
           boolean virtualApp,
           com.vmware.converter.OvfDeploymentOption[] deploymentOption,
           java.lang.String defaultDeploymentOption,
           com.vmware.converter.KeyValue[] entityName,
           com.vmware.converter.OvfConsumerOstNode annotatedOst,
     ...
     * @return network
     */
    public com.vmware.converter.OvfNetworkInfo[] getNetwork() {
        return network;
    }
     ...
     * @param network
     */
    public void setNetwork(com.vmware.converter.OvfNetworkInfo[] network) {
        this.network = network;
    }

    public com.vmware.converter.OvfNetworkInfo getNetwork(int i) {
        return this.network[i];
    }

    public void setNetwork(int i, com.vmware.converter.OvfNetworkInfo _value) {
     ...
     * @return property
     */
    public com.vmware.converter.VAppPropertyInfo[] getProperty() {
        return property;
    }
     ...
     * @param property
     */
    public void setProperty(com.vmware.converter.VAppPropertyInfo[] property) {
        this.property = property;
    }

    public com.vmware.converter.VAppPropertyInfo getProperty(int i) {
        return this.property[i];
    }

    public void setProperty(int i, com.vmware.converter.VAppPropertyInfo _value) {
     ...
     * @return productInfo
     */
    public com.vmware.converter.VAppProductInfo getProductInfo() {
        return productInfo;
    }
     ...
     * @param productInfo
     */
    public void setProductInfo(com.vmware.converter.VAppProductInfo productInfo) {
        this.productInfo = productInfo;
    }
     ...
     */
    public com.vmware.converter.OvfDeploymentOption[] getDeploymentOption() {
        return deploymentOption;
    }
     ...
     */
    public void setDeploymentOption(com.vmware.converter.OvfDeploymentOption[] deploymentOption) {
        this.deploymentOption = deploymentOption;
    }

    public com.vmware.converter.OvfDeploymentOption getDeploymentOption(int i) {
        return this.deploymentOption[i];
    }

    public void setDeploymentOption(int i, com.vmware.converter.OvfDeploymentOption _value) {
    ...
    /**
     * Gets the entityName value for this OvfParseDescriptorResult.
     * 
     * @return entityName
     */
    public com.vmware.converter.KeyValue[] getEntityName() {
        return entityName;
    }


    /**
     * Sets the entityName value for this OvfParseDescriptorResult.
     * 
     * @param entityName
     */
    public void setEntityName(com.vmware.converter.KeyValue[] entityName) {
        this.entityName = entityName;
    }

    public com.vmware.converter.KeyValue getEntityName(int i) {
        return this.entityName[i];
    }

    public void setEntityName(int i, com.vmware.converter.KeyValue _value) {
        this.entityName[i] = _value;
    }


    /**
     * Gets the annotatedOst value for this OvfParseDescriptorResult.
     * 
     * @return annotatedOst
     */
    public com.vmware.converter.OvfConsumerOstNode getAnnotatedOst() {
        return annotatedOst;
    }


    /**
     * Sets the annotatedOst value for this OvfParseDescriptorResult.
     * 
     * @param annotatedOst
     */
    public void setAnnotatedOst(com.vmware.converter.OvfConsumerOstNode annotatedOst) {
        this.annotatedOst = annotatedOst;
    }
        ...
        _equals = super.equals(obj) && 
            ...
            ((this.entityName==null && other.getEntityName()==null) || 
             (this.entityName!=null &&
              java.util.Arrays.equals(this.entityName, other.getEntityName()))) &&
            ((this.annotatedOst==null && other.getAnnotatedOst()==null) || 
             (this.annotatedOst!=null &&
              this.annotatedOst.equals(other.getAnnotatedOst()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getEntityName() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getEntityName());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getEntityName(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getAnnotatedOst() != null) {
            _hashCode += getAnnotatedOst().hashCode();
        }
        if (getError() != null) {
            for (int i=0;
    ...
    static {
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("annotatedOst");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "annotatedOst"));
