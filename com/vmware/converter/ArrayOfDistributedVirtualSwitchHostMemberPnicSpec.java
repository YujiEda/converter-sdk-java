...
public class ArrayOfDistributedVirtualSwitchHostMemberPnicSpec  implements java.io.Serializable {
    private com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] distributedVirtualSwitchHostMemberPnicSpec;

    public ArrayOfDistributedVirtualSwitchHostMemberPnicSpec() {
    }

    public ArrayOfDistributedVirtualSwitchHostMemberPnicSpec(
           com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] distributedVirtualSwitchHostMemberPnicSpec) {
     ...
     */
    public com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] getDistributedVirtualSwitchHostMemberPnicSpec() {
        return distributedVirtualSwitchHostMemberPnicSpec;
    }
     ...
     */
    public void setDistributedVirtualSwitchHostMemberPnicSpec(com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] distributedVirtualSwitchHostMemberPnicSpec) {
        this.distributedVirtualSwitchHostMemberPnicSpec = distributedVirtualSwitchHostMemberPnicSpec;
    }

    public com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec getDistributedVirtualSwitchHostMemberPnicSpec(int i) {
        return this.distributedVirtualSwitchHostMemberPnicSpec[i];
    }

    public void setDistributedVirtualSwitchHostMemberPnicSpec(int i, com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec _value) {
