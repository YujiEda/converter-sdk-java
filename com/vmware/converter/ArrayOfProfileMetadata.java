...
public class ArrayOfProfileMetadata  implements java.io.Serializable {
    private com.vmware.converter.ProfileMetadata[] profileMetadata;

    public ArrayOfProfileMetadata() {
    }

    public ArrayOfProfileMetadata(
           com.vmware.converter.ProfileMetadata[] profileMetadata) {
     ...
     */
    public com.vmware.converter.ProfileMetadata[] getProfileMetadata() {
        return profileMetadata;
    }
     ...
     */
    public void setProfileMetadata(com.vmware.converter.ProfileMetadata[] profileMetadata) {
        this.profileMetadata = profileMetadata;
    }

    public com.vmware.converter.ProfileMetadata getProfileMetadata(int i) {
        return this.profileMetadata[i];
    }

    public void setProfileMetadata(int i, com.vmware.converter.ProfileMetadata _value) {
