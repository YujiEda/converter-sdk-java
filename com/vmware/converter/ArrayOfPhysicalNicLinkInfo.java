...
public class ArrayOfPhysicalNicLinkInfo  implements java.io.Serializable {
    private com.vmware.converter.PhysicalNicLinkInfo[] physicalNicLinkInfo;

    public ArrayOfPhysicalNicLinkInfo() {
    }

    public ArrayOfPhysicalNicLinkInfo(
           com.vmware.converter.PhysicalNicLinkInfo[] physicalNicLinkInfo) {
     ...
     */
    public com.vmware.converter.PhysicalNicLinkInfo[] getPhysicalNicLinkInfo() {
        return physicalNicLinkInfo;
    }
     ...
     */
    public void setPhysicalNicLinkInfo(com.vmware.converter.PhysicalNicLinkInfo[] physicalNicLinkInfo) {
        this.physicalNicLinkInfo = physicalNicLinkInfo;
    }

    public com.vmware.converter.PhysicalNicLinkInfo getPhysicalNicLinkInfo(int i) {
        return this.physicalNicLinkInfo[i];
    }

    public void setPhysicalNicLinkInfo(int i, com.vmware.converter.PhysicalNicLinkInfo _value) {
