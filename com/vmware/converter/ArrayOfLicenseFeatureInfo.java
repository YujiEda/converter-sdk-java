...
public class ArrayOfLicenseFeatureInfo  implements java.io.Serializable {
    private com.vmware.converter.LicenseFeatureInfo[] licenseFeatureInfo;

    public ArrayOfLicenseFeatureInfo() {
    }

    public ArrayOfLicenseFeatureInfo(
           com.vmware.converter.LicenseFeatureInfo[] licenseFeatureInfo) {
     ...
     */
    public com.vmware.converter.LicenseFeatureInfo[] getLicenseFeatureInfo() {
        return licenseFeatureInfo;
    }
     ...
     */
    public void setLicenseFeatureInfo(com.vmware.converter.LicenseFeatureInfo[] licenseFeatureInfo) {
        this.licenseFeatureInfo = licenseFeatureInfo;
    }

    public com.vmware.converter.LicenseFeatureInfo getLicenseFeatureInfo(int i) {
        return this.licenseFeatureInfo[i];
    }

    public void setLicenseFeatureInfo(int i, com.vmware.converter.LicenseFeatureInfo _value) {
