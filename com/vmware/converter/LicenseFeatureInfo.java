...
public class LicenseFeatureInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.LicenseFeatureInfoState state;
    ...
    public LicenseFeatureInfo(
           ...
           com.vmware.converter.LicenseFeatureInfoState state,
     ...
     * @return state
     */
    public com.vmware.converter.LicenseFeatureInfoState getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(com.vmware.converter.LicenseFeatureInfoState state) {
        this.state = state;
    }
