...
public class ArrayOfMultipleCertificatesVerifyFaultThumbprintData  implements java.io.Serializable {
    private com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] multipleCertificatesVerifyFaultThumbprintData;

    public ArrayOfMultipleCertificatesVerifyFaultThumbprintData() {
    }

    public ArrayOfMultipleCertificatesVerifyFaultThumbprintData(
           com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] multipleCertificatesVerifyFaultThumbprintData) {
     ...
     */
    public com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] getMultipleCertificatesVerifyFaultThumbprintData() {
        return multipleCertificatesVerifyFaultThumbprintData;
    }
     ...
     */
    public void setMultipleCertificatesVerifyFaultThumbprintData(com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] multipleCertificatesVerifyFaultThumbprintData) {
        this.multipleCertificatesVerifyFaultThumbprintData = multipleCertificatesVerifyFaultThumbprintData;
    }

    public com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData getMultipleCertificatesVerifyFaultThumbprintData(int i) {
        return this.multipleCertificatesVerifyFaultThumbprintData[i];
    }

    public void setMultipleCertificatesVerifyFaultThumbprintData(int i, com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData _value) {
