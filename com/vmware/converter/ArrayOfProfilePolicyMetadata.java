...
public class ArrayOfProfilePolicyMetadata  implements java.io.Serializable {
    private com.vmware.converter.ProfilePolicyMetadata[] profilePolicyMetadata;

    public ArrayOfProfilePolicyMetadata() {
    }

    public ArrayOfProfilePolicyMetadata(
           com.vmware.converter.ProfilePolicyMetadata[] profilePolicyMetadata) {
     ...
     */
    public com.vmware.converter.ProfilePolicyMetadata[] getProfilePolicyMetadata() {
        return profilePolicyMetadata;
    }
     ...
     */
    public void setProfilePolicyMetadata(com.vmware.converter.ProfilePolicyMetadata[] profilePolicyMetadata) {
        this.profilePolicyMetadata = profilePolicyMetadata;
    }

    public com.vmware.converter.ProfilePolicyMetadata getProfilePolicyMetadata(int i) {
        return this.profilePolicyMetadata[i];
    }

    public void setProfilePolicyMetadata(int i, com.vmware.converter.ProfilePolicyMetadata _value) {
