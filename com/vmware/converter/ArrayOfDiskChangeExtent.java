...
public class ArrayOfDiskChangeExtent  implements java.io.Serializable {
    private com.vmware.converter.DiskChangeExtent[] diskChangeExtent;

    public ArrayOfDiskChangeExtent() {
    }

    public ArrayOfDiskChangeExtent(
           com.vmware.converter.DiskChangeExtent[] diskChangeExtent) {
     ...
     */
    public com.vmware.converter.DiskChangeExtent[] getDiskChangeExtent() {
        return diskChangeExtent;
    }
     ...
     */
    public void setDiskChangeExtent(com.vmware.converter.DiskChangeExtent[] diskChangeExtent) {
        this.diskChangeExtent = diskChangeExtent;
    }

    public com.vmware.converter.DiskChangeExtent getDiskChangeExtent(int i) {
        return this.diskChangeExtent[i];
    }

    public void setDiskChangeExtent(int i, com.vmware.converter.DiskChangeExtent _value) {
