...
public class ArrayOfVirtualMachineDatastoreInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineDatastoreInfo[] virtualMachineDatastoreInfo;

    public ArrayOfVirtualMachineDatastoreInfo() {
    }

    public ArrayOfVirtualMachineDatastoreInfo(
           com.vmware.converter.VirtualMachineDatastoreInfo[] virtualMachineDatastoreInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachineDatastoreInfo[] getVirtualMachineDatastoreInfo() {
        return virtualMachineDatastoreInfo;
    }
     ...
     */
    public void setVirtualMachineDatastoreInfo(com.vmware.converter.VirtualMachineDatastoreInfo[] virtualMachineDatastoreInfo) {
        this.virtualMachineDatastoreInfo = virtualMachineDatastoreInfo;
    }

    public com.vmware.converter.VirtualMachineDatastoreInfo getVirtualMachineDatastoreInfo(int i) {
        return this.virtualMachineDatastoreInfo[i];
    }

    public void setVirtualMachineDatastoreInfo(int i, com.vmware.converter.VirtualMachineDatastoreInfo _value) {
