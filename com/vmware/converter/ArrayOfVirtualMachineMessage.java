...
public class ArrayOfVirtualMachineMessage  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineMessage[] virtualMachineMessage;

    public ArrayOfVirtualMachineMessage() {
    }

    public ArrayOfVirtualMachineMessage(
           com.vmware.converter.VirtualMachineMessage[] virtualMachineMessage) {
     ...
     */
    public com.vmware.converter.VirtualMachineMessage[] getVirtualMachineMessage() {
        return virtualMachineMessage;
    }
     ...
     */
    public void setVirtualMachineMessage(com.vmware.converter.VirtualMachineMessage[] virtualMachineMessage) {
        this.virtualMachineMessage = virtualMachineMessage;
    }

    public com.vmware.converter.VirtualMachineMessage getVirtualMachineMessage(int i) {
        return this.virtualMachineMessage[i];
    }

    public void setVirtualMachineMessage(int i, com.vmware.converter.VirtualMachineMessage _value) {
