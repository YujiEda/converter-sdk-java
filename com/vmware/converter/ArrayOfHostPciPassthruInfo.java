...
public class ArrayOfHostPciPassthruInfo  implements java.io.Serializable {
    private com.vmware.converter.HostPciPassthruInfo[] hostPciPassthruInfo;

    public ArrayOfHostPciPassthruInfo() {
    }

    public ArrayOfHostPciPassthruInfo(
           com.vmware.converter.HostPciPassthruInfo[] hostPciPassthruInfo) {
     ...
     */
    public com.vmware.converter.HostPciPassthruInfo[] getHostPciPassthruInfo() {
        return hostPciPassthruInfo;
    }
     ...
     */
    public void setHostPciPassthruInfo(com.vmware.converter.HostPciPassthruInfo[] hostPciPassthruInfo) {
        this.hostPciPassthruInfo = hostPciPassthruInfo;
    }

    public com.vmware.converter.HostPciPassthruInfo getHostPciPassthruInfo(int i) {
        return this.hostPciPassthruInfo[i];
    }

    public void setHostPciPassthruInfo(int i, com.vmware.converter.HostPciPassthruInfo _value) {
