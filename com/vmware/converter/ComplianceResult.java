...
public class ComplianceResult  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.ComplianceFailure[] failure;
    ...
    public ComplianceResult(
           ...
           com.vmware.converter.ComplianceFailure[] failure) {
     ...
     * @return failure
     */
    public com.vmware.converter.ComplianceFailure[] getFailure() {
        return failure;
    }
     ...
     * @param failure
     */
    public void setFailure(com.vmware.converter.ComplianceFailure[] failure) {
        this.failure = failure;
    }

    public com.vmware.converter.ComplianceFailure getFailure(int i) {
        return this.failure[i];
    }

    public void setFailure(int i, com.vmware.converter.ComplianceFailure _value) {
