...
public class ArrayOfHostNasVolumeConfig  implements java.io.Serializable {
    private com.vmware.converter.HostNasVolumeConfig[] hostNasVolumeConfig;

    public ArrayOfHostNasVolumeConfig() {
    }

    public ArrayOfHostNasVolumeConfig(
           com.vmware.converter.HostNasVolumeConfig[] hostNasVolumeConfig) {
     ...
     */
    public com.vmware.converter.HostNasVolumeConfig[] getHostNasVolumeConfig() {
        return hostNasVolumeConfig;
    }
     ...
     */
    public void setHostNasVolumeConfig(com.vmware.converter.HostNasVolumeConfig[] hostNasVolumeConfig) {
        this.hostNasVolumeConfig = hostNasVolumeConfig;
    }

    public com.vmware.converter.HostNasVolumeConfig getHostNasVolumeConfig(int i) {
        return this.hostNasVolumeConfig[i];
    }

    public void setHostNasVolumeConfig(int i, com.vmware.converter.HostNasVolumeConfig _value) {
