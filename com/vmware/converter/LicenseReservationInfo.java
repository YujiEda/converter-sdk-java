...
public class LicenseReservationInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private java.lang.String key;

    private com.vmware.converter.LicenseReservationInfoState state;
    ...
    public LicenseReservationInfo(
           ...
           com.vmware.converter.LicenseReservationInfoState state,
           int required) {
        this.key = key;
        this.state = state;
     ...
     * @return state
     */
    public com.vmware.converter.LicenseReservationInfoState getState() {
        return state;
    }
     ...
     * @param state
     */
    public void setState(com.vmware.converter.LicenseReservationInfoState state) {
        this.state = state;
    }
