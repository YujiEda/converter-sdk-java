...
public class VmFaultToleranceOpIssuesList  extends com.vmware.converter.VmFaultToleranceIssue  implements java.io.Serializable {
    private com.vmware.converter.LocalizedMethodFault[] errors;

    private com.vmware.converter.LocalizedMethodFault[] warnings;
    ...
    public VmFaultToleranceOpIssuesList(
           ...
           com.vmware.converter.LocalizedMethodFault[] warnings) {
        super(
            faultCause,
            faultMessage);
        this.errors = errors;
     ...
     * @return warnings
     */
    public com.vmware.converter.LocalizedMethodFault[] getWarnings() {
        return warnings;
    }
     ...
     * @param warnings
     */
    public void setWarnings(com.vmware.converter.LocalizedMethodFault[] warnings) {
        this.warnings = warnings;
    }

    public com.vmware.converter.LocalizedMethodFault getWarnings(int i) {
        return this.warnings[i];
    }

    public void setWarnings(int i, com.vmware.converter.LocalizedMethodFault _value) {
