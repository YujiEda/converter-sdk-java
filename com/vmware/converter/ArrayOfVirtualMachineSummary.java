...
public class ArrayOfVirtualMachineSummary  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineSummary[] virtualMachineSummary;

    public ArrayOfVirtualMachineSummary() {
    }

    public ArrayOfVirtualMachineSummary(
           com.vmware.converter.VirtualMachineSummary[] virtualMachineSummary) {
     ...
     */
    public com.vmware.converter.VirtualMachineSummary[] getVirtualMachineSummary() {
        return virtualMachineSummary;
    }
     ...
     */
    public void setVirtualMachineSummary(com.vmware.converter.VirtualMachineSummary[] virtualMachineSummary) {
        this.virtualMachineSummary = virtualMachineSummary;
    }

    public com.vmware.converter.VirtualMachineSummary getVirtualMachineSummary(int i) {
        return this.virtualMachineSummary[i];
    }

    public void setVirtualMachineSummary(int i, com.vmware.converter.VirtualMachineSummary _value) {
