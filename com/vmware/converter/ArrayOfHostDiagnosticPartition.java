...
public class ArrayOfHostDiagnosticPartition  implements java.io.Serializable {
    private com.vmware.converter.HostDiagnosticPartition[] hostDiagnosticPartition;

    public ArrayOfHostDiagnosticPartition() {
    }

    public ArrayOfHostDiagnosticPartition(
           com.vmware.converter.HostDiagnosticPartition[] hostDiagnosticPartition) {
     ...
     */
    public com.vmware.converter.HostDiagnosticPartition[] getHostDiagnosticPartition() {
        return hostDiagnosticPartition;
    }
     ...
     */
    public void setHostDiagnosticPartition(com.vmware.converter.HostDiagnosticPartition[] hostDiagnosticPartition) {
        this.hostDiagnosticPartition = hostDiagnosticPartition;
    }

    public com.vmware.converter.HostDiagnosticPartition getHostDiagnosticPartition(int i) {
        return this.hostDiagnosticPartition[i];
    }

    public void setHostDiagnosticPartition(int i, com.vmware.converter.HostDiagnosticPartition _value) {
