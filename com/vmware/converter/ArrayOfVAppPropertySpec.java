...
public class ArrayOfVAppPropertySpec  implements java.io.Serializable {
    private com.vmware.converter.VAppPropertySpec[] VAppPropertySpec;

    public ArrayOfVAppPropertySpec() {
    }

    public ArrayOfVAppPropertySpec(
           com.vmware.converter.VAppPropertySpec[] VAppPropertySpec) {
     ...
     */
    public com.vmware.converter.VAppPropertySpec[] getVAppPropertySpec() {
        return VAppPropertySpec;
    }
     ...
     */
    public void setVAppPropertySpec(com.vmware.converter.VAppPropertySpec[] VAppPropertySpec) {
        this.VAppPropertySpec = VAppPropertySpec;
    }

    public com.vmware.converter.VAppPropertySpec getVAppPropertySpec(int i) {
        return this.VAppPropertySpec[i];
    }

    public void setVAppPropertySpec(int i, com.vmware.converter.VAppPropertySpec _value) {
