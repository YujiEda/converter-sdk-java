...
public class ArrayOfDvsServiceConsoleVNicProfile  implements java.io.Serializable {
    private com.vmware.converter.DvsServiceConsoleVNicProfile[] dvsServiceConsoleVNicProfile;

    public ArrayOfDvsServiceConsoleVNicProfile() {
    }

    public ArrayOfDvsServiceConsoleVNicProfile(
           com.vmware.converter.DvsServiceConsoleVNicProfile[] dvsServiceConsoleVNicProfile) {
     ...
     */
    public com.vmware.converter.DvsServiceConsoleVNicProfile[] getDvsServiceConsoleVNicProfile() {
        return dvsServiceConsoleVNicProfile;
    }
     ...
     */
    public void setDvsServiceConsoleVNicProfile(com.vmware.converter.DvsServiceConsoleVNicProfile[] dvsServiceConsoleVNicProfile) {
        this.dvsServiceConsoleVNicProfile = dvsServiceConsoleVNicProfile;
    }

    public com.vmware.converter.DvsServiceConsoleVNicProfile getDvsServiceConsoleVNicProfile(int i) {
        return this.dvsServiceConsoleVNicProfile[i];
    }

    public void setDvsServiceConsoleVNicProfile(int i, com.vmware.converter.DvsServiceConsoleVNicProfile _value) {
