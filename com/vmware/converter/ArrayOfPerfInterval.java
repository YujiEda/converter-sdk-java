...
public class ArrayOfPerfInterval  implements java.io.Serializable {
    private com.vmware.converter.PerfInterval[] perfInterval;

    public ArrayOfPerfInterval() {
    }

    public ArrayOfPerfInterval(
           com.vmware.converter.PerfInterval[] perfInterval) {
     ...
     * @return perfInterval
     */
    public com.vmware.converter.PerfInterval[] getPerfInterval() {
        return perfInterval;
    }
     ...
     * @param perfInterval
     */
    public void setPerfInterval(com.vmware.converter.PerfInterval[] perfInterval) {
        this.perfInterval = perfInterval;
    }

    public com.vmware.converter.PerfInterval getPerfInterval(int i) {
        return this.perfInterval[i];
    }

    public void setPerfInterval(int i, com.vmware.converter.PerfInterval _value) {
