...
public class EventDescriptionEventDetail  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    /**
     * Gets the longDescription value for this EventDescriptionEventDetail.
     * 
    ...
    /**
     * Sets the longDescription value for this EventDescriptionEventDetail.
     * 
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "longDescription"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
