...
public class ArrayOfVirtualMachineIdeDiskDeviceInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineIdeDiskDeviceInfo[] virtualMachineIdeDiskDeviceInfo;

    public ArrayOfVirtualMachineIdeDiskDeviceInfo() {
    }

    public ArrayOfVirtualMachineIdeDiskDeviceInfo(
           com.vmware.converter.VirtualMachineIdeDiskDeviceInfo[] virtualMachineIdeDiskDeviceInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachineIdeDiskDeviceInfo[] getVirtualMachineIdeDiskDeviceInfo() {
        return virtualMachineIdeDiskDeviceInfo;
    }
     ...
     */
    public void setVirtualMachineIdeDiskDeviceInfo(com.vmware.converter.VirtualMachineIdeDiskDeviceInfo[] virtualMachineIdeDiskDeviceInfo) {
        this.virtualMachineIdeDiskDeviceInfo = virtualMachineIdeDiskDeviceInfo;
    }

    public com.vmware.converter.VirtualMachineIdeDiskDeviceInfo getVirtualMachineIdeDiskDeviceInfo(int i) {
        return this.virtualMachineIdeDiskDeviceInfo[i];
    }

    public void setVirtualMachineIdeDiskDeviceInfo(int i, com.vmware.converter.VirtualMachineIdeDiskDeviceInfo _value) {
