...
public class ArrayOfPerfSampleInfo  implements java.io.Serializable {
    private com.vmware.converter.PerfSampleInfo[] perfSampleInfo;

    public ArrayOfPerfSampleInfo() {
    }

    public ArrayOfPerfSampleInfo(
           com.vmware.converter.PerfSampleInfo[] perfSampleInfo) {
     ...
     */
    public com.vmware.converter.PerfSampleInfo[] getPerfSampleInfo() {
        return perfSampleInfo;
    }
     ...
     */
    public void setPerfSampleInfo(com.vmware.converter.PerfSampleInfo[] perfSampleInfo) {
        this.perfSampleInfo = perfSampleInfo;
    }

    public com.vmware.converter.PerfSampleInfo getPerfSampleInfo(int i) {
        return this.perfSampleInfo[i];
    }

    public void setPerfSampleInfo(int i, com.vmware.converter.PerfSampleInfo _value) {
