...
public class ArrayOfPhysicalNicIpHint  implements java.io.Serializable {
    private com.vmware.converter.PhysicalNicIpHint[] physicalNicIpHint;

    public ArrayOfPhysicalNicIpHint() {
    }

    public ArrayOfPhysicalNicIpHint(
           com.vmware.converter.PhysicalNicIpHint[] physicalNicIpHint) {
     ...
     */
    public com.vmware.converter.PhysicalNicIpHint[] getPhysicalNicIpHint() {
        return physicalNicIpHint;
    }
     ...
     */
    public void setPhysicalNicIpHint(com.vmware.converter.PhysicalNicIpHint[] physicalNicIpHint) {
        this.physicalNicIpHint = physicalNicIpHint;
    }

    public com.vmware.converter.PhysicalNicIpHint getPhysicalNicIpHint(int i) {
        return this.physicalNicIpHint[i];
    }

    public void setPhysicalNicIpHint(int i, com.vmware.converter.PhysicalNicIpHint _value) {
