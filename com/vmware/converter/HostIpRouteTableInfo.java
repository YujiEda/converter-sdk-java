...
public class HostIpRouteTableInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostIpRouteEntry[] ipRoute;

    private com.vmware.converter.HostIpRouteEntry[] ipv6Route;

    public HostIpRouteTableInfo() {
    }

    public HostIpRouteTableInfo(
           com.vmware.converter.HostIpRouteEntry[] ipRoute,
           com.vmware.converter.HostIpRouteEntry[] ipv6Route) {
     ...
     * @return ipRoute
     */
    public com.vmware.converter.HostIpRouteEntry[] getIpRoute() {
        return ipRoute;
    }
     ...
     * @param ipRoute
     */
    public void setIpRoute(com.vmware.converter.HostIpRouteEntry[] ipRoute) {
        this.ipRoute = ipRoute;
    }

    public com.vmware.converter.HostIpRouteEntry getIpRoute(int i) {
        return this.ipRoute[i];
    }

    public void setIpRoute(int i, com.vmware.converter.HostIpRouteEntry _value) {
     ...
     * @return ipv6Route
     */
    public com.vmware.converter.HostIpRouteEntry[] getIpv6Route() {
        return ipv6Route;
    }
     ...
     * @param ipv6Route
     */
    public void setIpv6Route(com.vmware.converter.HostIpRouteEntry[] ipv6Route) {
        this.ipv6Route = ipv6Route;
    }

    public com.vmware.converter.HostIpRouteEntry getIpv6Route(int i) {
        return this.ipv6Route[i];
    }

    public void setIpv6Route(int i, com.vmware.converter.HostIpRouteEntry _value) {
