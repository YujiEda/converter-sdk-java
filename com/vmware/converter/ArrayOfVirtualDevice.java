...
public class ArrayOfVirtualDevice  implements java.io.Serializable {
    private com.vmware.converter.VirtualDevice[] virtualDevice;

    public ArrayOfVirtualDevice() {
    }

    public ArrayOfVirtualDevice(
           com.vmware.converter.VirtualDevice[] virtualDevice) {
     ...
     */
    public com.vmware.converter.VirtualDevice[] getVirtualDevice() {
        return virtualDevice;
    }
     ...
     * @param virtualDevice
     */
    public void setVirtualDevice(com.vmware.converter.VirtualDevice[] virtualDevice) {
        this.virtualDevice = virtualDevice;
    }

    public com.vmware.converter.VirtualDevice getVirtualDevice(int i) {
        return this.virtualDevice[i];
    }

    public void setVirtualDevice(int i, com.vmware.converter.VirtualDevice _value) {
