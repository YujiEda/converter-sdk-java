...
public class ClusterDrsFaultsFaultsByVm  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    public com.vmware.converter.LocalizedMethodFault getFault(int i) {
        return this.fault[i];
    }

    public void setFault(int i, com.vmware.converter.LocalizedMethodFault _value) {
        this.fault[i] = _value;
    }
