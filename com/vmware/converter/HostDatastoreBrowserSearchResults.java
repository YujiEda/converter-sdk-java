...
public class HostDatastoreBrowserSearchResults  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ManagedObjectReference datastore;

    private java.lang.String folderPath;

    private com.vmware.converter.FileInfo[] file;
    ...
    public HostDatastoreBrowserSearchResults(
           ...
           com.vmware.converter.FileInfo[] file) {
     ...
     * @return file
     */
    public com.vmware.converter.FileInfo[] getFile() {
        return file;
    }
     ...
     * @param file
     */
    public void setFile(com.vmware.converter.FileInfo[] file) {
        this.file = file;
    }

    public com.vmware.converter.FileInfo getFile(int i) {
        return this.file[i];
    }

    public void setFile(int i, com.vmware.converter.FileInfo _value) {
        this.file[i] = _value;
    }
