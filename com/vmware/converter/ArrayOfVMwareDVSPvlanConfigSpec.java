...
public class ArrayOfVMwareDVSPvlanConfigSpec  implements java.io.Serializable {
    private com.vmware.converter.VMwareDVSPvlanConfigSpec[] VMwareDVSPvlanConfigSpec;

    public ArrayOfVMwareDVSPvlanConfigSpec() {
    }

    public ArrayOfVMwareDVSPvlanConfigSpec(
           com.vmware.converter.VMwareDVSPvlanConfigSpec[] VMwareDVSPvlanConfigSpec) {
     ...
     */
    public com.vmware.converter.VMwareDVSPvlanConfigSpec[] getVMwareDVSPvlanConfigSpec() {
        return VMwareDVSPvlanConfigSpec;
    }
     ...
     */
    public void setVMwareDVSPvlanConfigSpec(com.vmware.converter.VMwareDVSPvlanConfigSpec[] VMwareDVSPvlanConfigSpec) {
        this.VMwareDVSPvlanConfigSpec = VMwareDVSPvlanConfigSpec;
    }

    public com.vmware.converter.VMwareDVSPvlanConfigSpec getVMwareDVSPvlanConfigSpec(int i) {
        return this.VMwareDVSPvlanConfigSpec[i];
    }

    public void setVMwareDVSPvlanConfigSpec(int i, com.vmware.converter.VMwareDVSPvlanConfigSpec _value) {
