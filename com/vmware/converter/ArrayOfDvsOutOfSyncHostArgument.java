...
public class ArrayOfDvsOutOfSyncHostArgument  implements java.io.Serializable {
    private com.vmware.converter.DvsOutOfSyncHostArgument[] dvsOutOfSyncHostArgument;

    public ArrayOfDvsOutOfSyncHostArgument() {
    }

    public ArrayOfDvsOutOfSyncHostArgument(
           com.vmware.converter.DvsOutOfSyncHostArgument[] dvsOutOfSyncHostArgument) {
     ...
     */
    public com.vmware.converter.DvsOutOfSyncHostArgument[] getDvsOutOfSyncHostArgument() {
        return dvsOutOfSyncHostArgument;
    }
     ...
     */
    public void setDvsOutOfSyncHostArgument(com.vmware.converter.DvsOutOfSyncHostArgument[] dvsOutOfSyncHostArgument) {
        this.dvsOutOfSyncHostArgument = dvsOutOfSyncHostArgument;
    }

    public com.vmware.converter.DvsOutOfSyncHostArgument getDvsOutOfSyncHostArgument(int i) {
        return this.dvsOutOfSyncHostArgument[i];
    }

    public void setDvsOutOfSyncHostArgument(int i, com.vmware.converter.DvsOutOfSyncHostArgument _value) {
