...
public class ArrayOfHostPortGroupConfig  implements java.io.Serializable {
    private com.vmware.converter.HostPortGroupConfig[] hostPortGroupConfig;

    public ArrayOfHostPortGroupConfig() {
    }

    public ArrayOfHostPortGroupConfig(
           com.vmware.converter.HostPortGroupConfig[] hostPortGroupConfig) {
     ...
     */
    public com.vmware.converter.HostPortGroupConfig[] getHostPortGroupConfig() {
        return hostPortGroupConfig;
    }
     ...
     */
    public void setHostPortGroupConfig(com.vmware.converter.HostPortGroupConfig[] hostPortGroupConfig) {
        this.hostPortGroupConfig = hostPortGroupConfig;
    }

    public com.vmware.converter.HostPortGroupConfig getHostPortGroupConfig(int i) {
        return this.hostPortGroupConfig[i];
    }

    public void setHostPortGroupConfig(int i, com.vmware.converter.HostPortGroupConfig _value) {
