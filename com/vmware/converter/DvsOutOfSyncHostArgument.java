...
public class DvsOutOfSyncHostArgument  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostEventArgument outOfSyncHost;
    ...
    public DvsOutOfSyncHostArgument(
           com.vmware.converter.HostEventArgument outOfSyncHost,
     ...
     */
    public com.vmware.converter.HostEventArgument getOutOfSyncHost() {
        return outOfSyncHost;
    }
     ...
     * @param outOfSyncHost
     */
    public void setOutOfSyncHost(com.vmware.converter.HostEventArgument outOfSyncHost) {
        this.outOfSyncHost = outOfSyncHost;
    }
