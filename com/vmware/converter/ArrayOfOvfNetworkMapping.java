...
public class ArrayOfOvfNetworkMapping  implements java.io.Serializable {
    private com.vmware.converter.OvfNetworkMapping[] ovfNetworkMapping;

    public ArrayOfOvfNetworkMapping() {
    }

    public ArrayOfOvfNetworkMapping(
           com.vmware.converter.OvfNetworkMapping[] ovfNetworkMapping) {
     ...
     */
    public com.vmware.converter.OvfNetworkMapping[] getOvfNetworkMapping() {
        return ovfNetworkMapping;
    }
     ...
     */
    public void setOvfNetworkMapping(com.vmware.converter.OvfNetworkMapping[] ovfNetworkMapping) {
        this.ovfNetworkMapping = ovfNetworkMapping;
    }

    public com.vmware.converter.OvfNetworkMapping getOvfNetworkMapping(int i) {
        return this.ovfNetworkMapping[i];
    }

    public void setOvfNetworkMapping(int i, com.vmware.converter.OvfNetworkMapping _value) {
