...
public class ArrayOfKeyValue  implements java.io.Serializable {
    private com.vmware.converter.KeyValue[] keyValue;

    public ArrayOfKeyValue() {
    }

    public ArrayOfKeyValue(
           com.vmware.converter.KeyValue[] keyValue) {
     ...
     * @return keyValue
     */
    public com.vmware.converter.KeyValue[] getKeyValue() {
        return keyValue;
    }
     ...
     * @param keyValue
     */
    public void setKeyValue(com.vmware.converter.KeyValue[] keyValue) {
        this.keyValue = keyValue;
    }

    public com.vmware.converter.KeyValue getKeyValue(int i) {
        return this.keyValue[i];
    }

    public void setKeyValue(int i, com.vmware.converter.KeyValue _value) {
