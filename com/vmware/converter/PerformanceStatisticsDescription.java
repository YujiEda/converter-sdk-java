...
public class PerformanceStatisticsDescription  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.PerfInterval[] intervals;

    public PerformanceStatisticsDescription() {
    }

    public PerformanceStatisticsDescription(
           com.vmware.converter.PerfInterval[] intervals) {
     ...
     * @return intervals
     */
    public com.vmware.converter.PerfInterval[] getIntervals() {
        return intervals;
    }
     ...
     * @param intervals
     */
    public void setIntervals(com.vmware.converter.PerfInterval[] intervals) {
        this.intervals = intervals;
    }

    public com.vmware.converter.PerfInterval getIntervals(int i) {
        return this.intervals[i];
    }

    public void setIntervals(int i, com.vmware.converter.PerfInterval _value) {
