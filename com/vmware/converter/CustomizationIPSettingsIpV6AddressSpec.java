...
public class CustomizationIPSettingsIpV6AddressSpec  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.CustomizationIpV6Generator[] ip;
    ...
    public CustomizationIPSettingsIpV6AddressSpec(
           com.vmware.converter.CustomizationIpV6Generator[] ip,
     ...
     * @return ip
     */
    public com.vmware.converter.CustomizationIpV6Generator[] getIp() {
        return ip;
    }
     ...
     * @param ip
     */
    public void setIp(com.vmware.converter.CustomizationIpV6Generator[] ip) {
        this.ip = ip;
    }

    public com.vmware.converter.CustomizationIpV6Generator getIp(int i) {
        return this.ip[i];
    }

    public void setIp(int i, com.vmware.converter.CustomizationIpV6Generator _value) {
        this.ip[i] = _value;
    }
