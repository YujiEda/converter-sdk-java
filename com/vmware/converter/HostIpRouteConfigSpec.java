...
public class HostIpRouteConfigSpec  extends com.vmware.converter.HostIpRouteConfig  implements java.io.Serializable {
    private com.vmware.converter.HostVirtualNicConnection gatewayDeviceConnection;

    private com.vmware.converter.HostVirtualNicConnection ipV6GatewayDeviceConnection;
    ...
    public HostIpRouteConfigSpec(
           ...
           com.vmware.converter.HostVirtualNicConnection gatewayDeviceConnection,
           com.vmware.converter.HostVirtualNicConnection ipV6GatewayDeviceConnection) {
        super(
            defaultGateway,
            gatewayDevice,
            ipV6DefaultGateway,
     ...
     */
    public com.vmware.converter.HostVirtualNicConnection getGatewayDeviceConnection() {
        return gatewayDeviceConnection;
    }
     ...
     */
    public void setGatewayDeviceConnection(com.vmware.converter.HostVirtualNicConnection gatewayDeviceConnection) {
        this.gatewayDeviceConnection = gatewayDeviceConnection;
    }
     ...
     */
    public com.vmware.converter.HostVirtualNicConnection getIpV6GatewayDeviceConnection() {
        return ipV6GatewayDeviceConnection;
    }
     ...
     */
    public void setIpV6GatewayDeviceConnection(com.vmware.converter.HostVirtualNicConnection ipV6GatewayDeviceConnection) {
        this.ipV6GatewayDeviceConnection = ipV6GatewayDeviceConnection;
    }
