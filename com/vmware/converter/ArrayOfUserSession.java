...
public class ArrayOfUserSession  implements java.io.Serializable {
    private com.vmware.converter.UserSession[] userSession;

    public ArrayOfUserSession() {
    }

    public ArrayOfUserSession(
           com.vmware.converter.UserSession[] userSession) {
     ...
     * @return userSession
     */
    public com.vmware.converter.UserSession[] getUserSession() {
        return userSession;
    }
     ...
     * @param userSession
     */
    public void setUserSession(com.vmware.converter.UserSession[] userSession) {
        this.userSession = userSession;
    }

    public com.vmware.converter.UserSession getUserSession(int i) {
        return this.userSession[i];
    }

    public void setUserSession(int i, com.vmware.converter.UserSession _value) {
