...
public class ClusterDasAamHostInfo  extends com.vmware.converter.ClusterDasHostInfo  implements java.io.Serializable {
    private com.vmware.converter.ClusterDasAamNodeState[] hostDasState;
    ...
    public ClusterDasAamHostInfo(
           com.vmware.converter.ClusterDasAamNodeState[] hostDasState,
     ...
     * @return hostDasState
     */
    public com.vmware.converter.ClusterDasAamNodeState[] getHostDasState() {
        return hostDasState;
    }
     ...
     * @param hostDasState
     */
    public void setHostDasState(com.vmware.converter.ClusterDasAamNodeState[] hostDasState) {
        this.hostDasState = hostDasState;
    }

    public com.vmware.converter.ClusterDasAamNodeState getHostDasState(int i) {
        return this.hostDasState[i];
    }

    public void setHostDasState(int i, com.vmware.converter.ClusterDasAamNodeState _value) {
