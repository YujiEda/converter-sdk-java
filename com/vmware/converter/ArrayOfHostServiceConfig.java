...
public class ArrayOfHostServiceConfig  implements java.io.Serializable {
    private com.vmware.converter.HostServiceConfig[] hostServiceConfig;

    public ArrayOfHostServiceConfig() {
    }

    public ArrayOfHostServiceConfig(
           com.vmware.converter.HostServiceConfig[] hostServiceConfig) {
     ...
     */
    public com.vmware.converter.HostServiceConfig[] getHostServiceConfig() {
        return hostServiceConfig;
    }
     ...
     */
    public void setHostServiceConfig(com.vmware.converter.HostServiceConfig[] hostServiceConfig) {
        this.hostServiceConfig = hostServiceConfig;
    }

    public com.vmware.converter.HostServiceConfig getHostServiceConfig(int i) {
        return this.hostServiceConfig[i];
    }

    public void setHostServiceConfig(int i, com.vmware.converter.HostServiceConfig _value) {
