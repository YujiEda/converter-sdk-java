...
public class ArrayOfHostDhcpServiceConfig  implements java.io.Serializable {
    private com.vmware.converter.HostDhcpServiceConfig[] hostDhcpServiceConfig;

    public ArrayOfHostDhcpServiceConfig() {
    }

    public ArrayOfHostDhcpServiceConfig(
           com.vmware.converter.HostDhcpServiceConfig[] hostDhcpServiceConfig) {
     ...
     */
    public com.vmware.converter.HostDhcpServiceConfig[] getHostDhcpServiceConfig() {
        return hostDhcpServiceConfig;
    }
     ...
     */
    public void setHostDhcpServiceConfig(com.vmware.converter.HostDhcpServiceConfig[] hostDhcpServiceConfig) {
        this.hostDhcpServiceConfig = hostDhcpServiceConfig;
    }

    public com.vmware.converter.HostDhcpServiceConfig getHostDhcpServiceConfig(int i) {
        return this.hostDhcpServiceConfig[i];
    }

    public void setHostDhcpServiceConfig(int i, com.vmware.converter.HostDhcpServiceConfig _value) {
