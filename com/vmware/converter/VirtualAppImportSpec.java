...
public class VirtualAppImportSpec  extends com.vmware.converter.ImportSpec  implements java.io.Serializable {
    private java.lang.String name;

    private com.vmware.converter.VAppConfigSpec vAppConfigSpec;

    private com.vmware.converter.ResourceConfigSpec resourcePoolSpec;

    private com.vmware.converter.ImportSpec[] child;
    ...
    public VirtualAppImportSpec(
           ...
           com.vmware.converter.VAppConfigSpec vAppConfigSpec,
           com.vmware.converter.ResourceConfigSpec resourcePoolSpec,
           com.vmware.converter.ImportSpec[] child) {
        super(
            entityConfig,
            instantiationOst);
        this.name = name;
     ...
     */
    public com.vmware.converter.VAppConfigSpec getVAppConfigSpec() {
        return vAppConfigSpec;
    }
     ...
     */
    public void setVAppConfigSpec(com.vmware.converter.VAppConfigSpec vAppConfigSpec) {
        this.vAppConfigSpec = vAppConfigSpec;
    }
     ...
     */
    public com.vmware.converter.ResourceConfigSpec getResourcePoolSpec() {
        return resourcePoolSpec;
    }
     ...
     */
    public void setResourcePoolSpec(com.vmware.converter.ResourceConfigSpec resourcePoolSpec) {
        this.resourcePoolSpec = resourcePoolSpec;
    }
     ...
     * @return child
     */
    public com.vmware.converter.ImportSpec[] getChild() {
        return child;
    }
     ...
     * @param child
     */
    public void setChild(com.vmware.converter.ImportSpec[] child) {
        this.child = child;
    }

    public com.vmware.converter.ImportSpec getChild(int i) {
        return this.child[i];
    }

    public void setChild(int i, com.vmware.converter.ImportSpec _value) {
        this.child[i] = _value;
    }
