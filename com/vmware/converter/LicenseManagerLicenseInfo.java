...
public class LicenseManagerLicenseInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    private com.vmware.converter.KeyValue[] labels;
    ...
    public LicenseManagerLicenseInfo(
           ...
           com.vmware.converter.KeyValue[] labels) {
     ...
     * @return labels
     */
    public com.vmware.converter.KeyValue[] getLabels() {
        return labels;
    }
     ...
     * @param labels
     */
    public void setLabels(com.vmware.converter.KeyValue[] labels) {
        this.labels = labels;
    }

    public com.vmware.converter.KeyValue getLabels(int i) {
        return this.labels[i];
    }

    public void setLabels(int i, com.vmware.converter.KeyValue _value) {
