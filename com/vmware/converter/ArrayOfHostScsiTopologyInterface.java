...
public class ArrayOfHostScsiTopologyInterface  implements java.io.Serializable {
    private com.vmware.converter.HostScsiTopologyInterface[] hostScsiTopologyInterface;

    public ArrayOfHostScsiTopologyInterface() {
    }

    public ArrayOfHostScsiTopologyInterface(
           com.vmware.converter.HostScsiTopologyInterface[] hostScsiTopologyInterface) {
     ...
     */
    public com.vmware.converter.HostScsiTopologyInterface[] getHostScsiTopologyInterface() {
        return hostScsiTopologyInterface;
    }
     ...
     */
    public void setHostScsiTopologyInterface(com.vmware.converter.HostScsiTopologyInterface[] hostScsiTopologyInterface) {
        this.hostScsiTopologyInterface = hostScsiTopologyInterface;
    }

    public com.vmware.converter.HostScsiTopologyInterface getHostScsiTopologyInterface(int i) {
        return this.hostScsiTopologyInterface[i];
    }

    public void setHostScsiTopologyInterface(int i, com.vmware.converter.HostScsiTopologyInterface _value) {
