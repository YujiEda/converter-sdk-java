...
public class ArrayOfComplianceFailure  implements java.io.Serializable {
    private com.vmware.converter.ComplianceFailure[] complianceFailure;

    public ArrayOfComplianceFailure() {
    }

    public ArrayOfComplianceFailure(
           com.vmware.converter.ComplianceFailure[] complianceFailure) {
     ...
     */
    public com.vmware.converter.ComplianceFailure[] getComplianceFailure() {
        return complianceFailure;
    }
     ...
     */
    public void setComplianceFailure(com.vmware.converter.ComplianceFailure[] complianceFailure) {
        this.complianceFailure = complianceFailure;
    }

    public com.vmware.converter.ComplianceFailure getComplianceFailure(int i) {
        return this.complianceFailure[i];
    }

    public void setComplianceFailure(int i, com.vmware.converter.ComplianceFailure _value) {
