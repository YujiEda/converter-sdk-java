...
public class VirtualEthernetCardDistributedVirtualPortBackingInfo  extends com.vmware.converter.VirtualDeviceBackingInfo  implements java.io.Serializable {
    private com.vmware.converter.DistributedVirtualSwitchPortConnection port;

    public VirtualEthernetCardDistributedVirtualPortBackingInfo() {
    }

    public VirtualEthernetCardDistributedVirtualPortBackingInfo(
           com.vmware.converter.DistributedVirtualSwitchPortConnection port) {
        this.port = port;
    }
     ...
     * @return port
     */
    public com.vmware.converter.DistributedVirtualSwitchPortConnection getPort() {
        return port;
    }
     ...
     * @param port
     */
    public void setPort(com.vmware.converter.DistributedVirtualSwitchPortConnection port) {
        this.port = port;
    }
