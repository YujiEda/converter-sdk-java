...
public class ArrayOfClusterDrsVmConfigSpec  implements java.io.Serializable {
    private com.vmware.converter.ClusterDrsVmConfigSpec[] clusterDrsVmConfigSpec;

    public ArrayOfClusterDrsVmConfigSpec() {
    }

    public ArrayOfClusterDrsVmConfigSpec(
           com.vmware.converter.ClusterDrsVmConfigSpec[] clusterDrsVmConfigSpec) {
     ...
     */
    public com.vmware.converter.ClusterDrsVmConfigSpec[] getClusterDrsVmConfigSpec() {
        return clusterDrsVmConfigSpec;
    }
     ...
     */
    public void setClusterDrsVmConfigSpec(com.vmware.converter.ClusterDrsVmConfigSpec[] clusterDrsVmConfigSpec) {
        this.clusterDrsVmConfigSpec = clusterDrsVmConfigSpec;
    }

    public com.vmware.converter.ClusterDrsVmConfigSpec getClusterDrsVmConfigSpec(int i) {
        return this.clusterDrsVmConfigSpec[i];
    }

    public void setClusterDrsVmConfigSpec(int i, com.vmware.converter.ClusterDrsVmConfigSpec _value) {
