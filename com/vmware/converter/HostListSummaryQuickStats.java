...
public class HostListSummaryQuickStats  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    ...
    /**
     * Gets the uptime value for this HostListSummaryQuickStats.
     * 
     * @return uptime
     */
    ...
    /**
     * Sets the uptime value for this HostListSummaryQuickStats.
     * 
     * @param uptime
     */
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:vim25", "uptime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "int"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
