...
public class MultipleCertificatesVerifyFault  extends com.vmware.converter.HostConnectFault  implements java.io.Serializable {
    private com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] thumbprintData;
    ...
    public MultipleCertificatesVerifyFault(
           ...
           com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] thumbprintData) {
        super(
            faultCause,
            faultMessage);
     ...
     */
    public com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] getThumbprintData() {
        return thumbprintData;
    }
     ...
     */
    public void setThumbprintData(com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData[] thumbprintData) {
        this.thumbprintData = thumbprintData;
    }

    public com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData getThumbprintData(int i) {
        return this.thumbprintData[i];
    }

    public void setThumbprintData(int i, com.vmware.converter.MultipleCertificatesVerifyFaultThumbprintData _value) {
