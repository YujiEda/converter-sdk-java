...
public class DiskChangeInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private long startOffset;

    private long length;

    private com.vmware.converter.DiskChangeExtent[] changedArea;
    ...
    public DiskChangeInfo(
           long startOffset,
           long length,
           com.vmware.converter.DiskChangeExtent[] changedArea) {
     ...
     * @return changedArea
     */
    public com.vmware.converter.DiskChangeExtent[] getChangedArea() {
        return changedArea;
    }
     ...
     * @param changedArea
     */
    public void setChangedArea(com.vmware.converter.DiskChangeExtent[] changedArea) {
        this.changedArea = changedArea;
    }

    public com.vmware.converter.DiskChangeExtent getChangedArea(int i) {
        return this.changedArea[i];
    }

    public void setChangedArea(int i, com.vmware.converter.DiskChangeExtent _value) {
