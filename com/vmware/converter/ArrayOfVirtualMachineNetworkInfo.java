...
public class ArrayOfVirtualMachineNetworkInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineNetworkInfo[] virtualMachineNetworkInfo;

    public ArrayOfVirtualMachineNetworkInfo() {
    }

    public ArrayOfVirtualMachineNetworkInfo(
           com.vmware.converter.VirtualMachineNetworkInfo[] virtualMachineNetworkInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachineNetworkInfo[] getVirtualMachineNetworkInfo() {
        return virtualMachineNetworkInfo;
    }
     ...
     */
    public void setVirtualMachineNetworkInfo(com.vmware.converter.VirtualMachineNetworkInfo[] virtualMachineNetworkInfo) {
        this.virtualMachineNetworkInfo = virtualMachineNetworkInfo;
    }

    public com.vmware.converter.VirtualMachineNetworkInfo getVirtualMachineNetworkInfo(int i) {
        return this.virtualMachineNetworkInfo[i];
    }

    public void setVirtualMachineNetworkInfo(int i, com.vmware.converter.VirtualMachineNetworkInfo _value) {
