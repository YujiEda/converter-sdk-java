...
public class ArrayOfPhysicalNicConfig  implements java.io.Serializable {
    private com.vmware.converter.PhysicalNicConfig[] physicalNicConfig;

    public ArrayOfPhysicalNicConfig() {
    }

    public ArrayOfPhysicalNicConfig(
           com.vmware.converter.PhysicalNicConfig[] physicalNicConfig) {
     ...
     */
    public com.vmware.converter.PhysicalNicConfig[] getPhysicalNicConfig() {
        return physicalNicConfig;
    }
     ...
     */
    public void setPhysicalNicConfig(com.vmware.converter.PhysicalNicConfig[] physicalNicConfig) {
        this.physicalNicConfig = physicalNicConfig;
    }

    public com.vmware.converter.PhysicalNicConfig getPhysicalNicConfig(int i) {
        return this.physicalNicConfig[i];
    }

    public void setPhysicalNicConfig(int i, com.vmware.converter.PhysicalNicConfig _value) {
