...
public class ArrayOfVirtualMachinePciPassthroughInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachinePciPassthroughInfo[] virtualMachinePciPassthroughInfo;

    public ArrayOfVirtualMachinePciPassthroughInfo() {
    }

    public ArrayOfVirtualMachinePciPassthroughInfo(
           com.vmware.converter.VirtualMachinePciPassthroughInfo[] virtualMachinePciPassthroughInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachinePciPassthroughInfo[] getVirtualMachinePciPassthroughInfo() {
        return virtualMachinePciPassthroughInfo;
    }
     ...
     */
    public void setVirtualMachinePciPassthroughInfo(com.vmware.converter.VirtualMachinePciPassthroughInfo[] virtualMachinePciPassthroughInfo) {
        this.virtualMachinePciPassthroughInfo = virtualMachinePciPassthroughInfo;
    }

    public com.vmware.converter.VirtualMachinePciPassthroughInfo getVirtualMachinePciPassthroughInfo(int i) {
        return this.virtualMachinePciPassthroughInfo[i];
    }

    public void setVirtualMachinePciPassthroughInfo(int i, com.vmware.converter.VirtualMachinePciPassthroughInfo _value) {
