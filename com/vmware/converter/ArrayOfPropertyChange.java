...
public class ArrayOfPropertyChange  implements java.io.Serializable {
    private com.vmware.converter.PropertyChange[] propertyChange;

    public ArrayOfPropertyChange() {
    }

    public ArrayOfPropertyChange(
           com.vmware.converter.PropertyChange[] propertyChange) {
     ...
     */
    public com.vmware.converter.PropertyChange[] getPropertyChange() {
        return propertyChange;
    }
     ...
     */
    public void setPropertyChange(com.vmware.converter.PropertyChange[] propertyChange) {
        this.propertyChange = propertyChange;
    }

    public com.vmware.converter.PropertyChange getPropertyChange(int i) {
        return this.propertyChange[i];
    }

    public void setPropertyChange(int i, com.vmware.converter.PropertyChange _value) {
