...
public class AlarmTriggeringAction  extends com.vmware.converter.AlarmAction  implements java.io.Serializable {
    private com.vmware.converter.Action action;

    private com.vmware.converter.AlarmTriggeringActionTransitionSpec[] transitionSpecs;
    ...
    public AlarmTriggeringAction(
           com.vmware.converter.Action action,
           com.vmware.converter.AlarmTriggeringActionTransitionSpec[] transitionSpecs,
     ...
     * @return action
     */
    public com.vmware.converter.Action getAction() {
        return action;
    }
     ...
     * @param action
     */
    public void setAction(com.vmware.converter.Action action) {
        this.action = action;
    }
     ...
     */
    public com.vmware.converter.AlarmTriggeringActionTransitionSpec[] getTransitionSpecs() {
        return transitionSpecs;
    }
     ...
     */
    public void setTransitionSpecs(com.vmware.converter.AlarmTriggeringActionTransitionSpec[] transitionSpecs) {
        this.transitionSpecs = transitionSpecs;
    }

    public com.vmware.converter.AlarmTriggeringActionTransitionSpec getTransitionSpecs(int i) {
        return this.transitionSpecs[i];
    }

    public void setTransitionSpecs(int i, com.vmware.converter.AlarmTriggeringActionTransitionSpec _value) {
