...
public class HostHardwareStatusInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostHardwareElementInfo[] memoryStatusInfo;

    private com.vmware.converter.HostHardwareElementInfo[] cpuStatusInfo;

    private com.vmware.converter.HostStorageElementInfo[] storageStatusInfo;

    public HostHardwareStatusInfo() {
    }

    public HostHardwareStatusInfo(
           com.vmware.converter.HostHardwareElementInfo[] memoryStatusInfo,
           com.vmware.converter.HostHardwareElementInfo[] cpuStatusInfo,
           com.vmware.converter.HostStorageElementInfo[] storageStatusInfo) {
     ...
     */
    public com.vmware.converter.HostHardwareElementInfo[] getMemoryStatusInfo() {
        return memoryStatusInfo;
    }
     ...
     */
    public void setMemoryStatusInfo(com.vmware.converter.HostHardwareElementInfo[] memoryStatusInfo) {
        this.memoryStatusInfo = memoryStatusInfo;
    }

    public com.vmware.converter.HostHardwareElementInfo getMemoryStatusInfo(int i) {
        return this.memoryStatusInfo[i];
    }

    public void setMemoryStatusInfo(int i, com.vmware.converter.HostHardwareElementInfo _value) {
     ...
     */
    public com.vmware.converter.HostHardwareElementInfo[] getCpuStatusInfo() {
        return cpuStatusInfo;
    }
     ...
     * @param cpuStatusInfo
     */
    public void setCpuStatusInfo(com.vmware.converter.HostHardwareElementInfo[] cpuStatusInfo) {
        this.cpuStatusInfo = cpuStatusInfo;
    }

    public com.vmware.converter.HostHardwareElementInfo getCpuStatusInfo(int i) {
        return this.cpuStatusInfo[i];
    }

    public void setCpuStatusInfo(int i, com.vmware.converter.HostHardwareElementInfo _value) {
     ...
     */
    public com.vmware.converter.HostStorageElementInfo[] getStorageStatusInfo() {
        return storageStatusInfo;
    }
     ...
     */
    public void setStorageStatusInfo(com.vmware.converter.HostStorageElementInfo[] storageStatusInfo) {
        this.storageStatusInfo = storageStatusInfo;
    }

    public com.vmware.converter.HostStorageElementInfo getStorageStatusInfo(int i) {
        return this.storageStatusInfo[i];
    }

    public void setStorageStatusInfo(int i, com.vmware.converter.HostStorageElementInfo _value) {
