...
public class ArrayOfHostPortGroup  implements java.io.Serializable {
    private com.vmware.converter.HostPortGroup[] hostPortGroup;

    public ArrayOfHostPortGroup() {
    }

    public ArrayOfHostPortGroup(
           com.vmware.converter.HostPortGroup[] hostPortGroup) {
     ...
     */
    public com.vmware.converter.HostPortGroup[] getHostPortGroup() {
        return hostPortGroup;
    }
     ...
     * @param hostPortGroup
     */
    public void setHostPortGroup(com.vmware.converter.HostPortGroup[] hostPortGroup) {
        this.hostPortGroup = hostPortGroup;
    }

    public com.vmware.converter.HostPortGroup getHostPortGroup(int i) {
        return this.hostPortGroup[i];
    }

    public void setHostPortGroup(int i, com.vmware.converter.HostPortGroup _value) {
