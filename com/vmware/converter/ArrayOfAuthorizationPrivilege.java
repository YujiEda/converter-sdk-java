...
public class ArrayOfAuthorizationPrivilege  implements java.io.Serializable {
    private com.vmware.converter.AuthorizationPrivilege[] authorizationPrivilege;

    public ArrayOfAuthorizationPrivilege() {
    }

    public ArrayOfAuthorizationPrivilege(
           com.vmware.converter.AuthorizationPrivilege[] authorizationPrivilege) {
     ...
     */
    public com.vmware.converter.AuthorizationPrivilege[] getAuthorizationPrivilege() {
        return authorizationPrivilege;
    }
     ...
     */
    public void setAuthorizationPrivilege(com.vmware.converter.AuthorizationPrivilege[] authorizationPrivilege) {
        this.authorizationPrivilege = authorizationPrivilege;
    }

    public com.vmware.converter.AuthorizationPrivilege getAuthorizationPrivilege(int i) {
        return this.authorizationPrivilege[i];
    }

    public void setAuthorizationPrivilege(int i, com.vmware.converter.AuthorizationPrivilege _value) {
