...
public class FaultToleranceSecondaryOpResult  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ManagedObjectReference vm;

    private boolean powerOnAttempted;

    private com.vmware.converter.ClusterPowerOnVmResult powerOnResult;
    ...
    public FaultToleranceSecondaryOpResult(
           ...
           com.vmware.converter.ClusterPowerOnVmResult powerOnResult) {
        this.vm = vm;
     ...
     */
    public com.vmware.converter.ClusterPowerOnVmResult getPowerOnResult() {
        return powerOnResult;
    }
     ...
     * @param powerOnResult
     */
    public void setPowerOnResult(com.vmware.converter.ClusterPowerOnVmResult powerOnResult) {
        this.powerOnResult = powerOnResult;
    }
