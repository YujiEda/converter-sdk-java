...
public class ArrayOfExtension  implements java.io.Serializable {
    private com.vmware.converter.Extension[] extension;

    public ArrayOfExtension() {
    }

    public ArrayOfExtension(
           com.vmware.converter.Extension[] extension) {
     ...
     * @return extension
     */
    public com.vmware.converter.Extension[] getExtension() {
        return extension;
    }
     ...
     * @param extension
     */
    public void setExtension(com.vmware.converter.Extension[] extension) {
        this.extension = extension;
    }

    public com.vmware.converter.Extension getExtension(int i) {
        return this.extension[i];
    }

    public void setExtension(int i, com.vmware.converter.Extension _value) {
