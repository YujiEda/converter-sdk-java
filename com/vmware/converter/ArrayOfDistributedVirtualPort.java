...
public class ArrayOfDistributedVirtualPort  implements java.io.Serializable {
    private com.vmware.converter.DistributedVirtualPort[] distributedVirtualPort;

    public ArrayOfDistributedVirtualPort() {
    }

    public ArrayOfDistributedVirtualPort(
           com.vmware.converter.DistributedVirtualPort[] distributedVirtualPort) {
     ...
     */
    public com.vmware.converter.DistributedVirtualPort[] getDistributedVirtualPort() {
        return distributedVirtualPort;
    }
     ...
     */
    public void setDistributedVirtualPort(com.vmware.converter.DistributedVirtualPort[] distributedVirtualPort) {
        this.distributedVirtualPort = distributedVirtualPort;
    }

    public com.vmware.converter.DistributedVirtualPort getDistributedVirtualPort(int i) {
        return this.distributedVirtualPort[i];
    }

    public void setDistributedVirtualPort(int i, com.vmware.converter.DistributedVirtualPort _value) {
