...
public class SharesInfo  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private int shares;

    private com.vmware.converter.SharesLevel level;
    ...
    public SharesInfo(
           int shares,
           com.vmware.converter.SharesLevel level) {
        this.shares = shares;
        this.level = level;
    }
     ...
     * @return level
     */
    public com.vmware.converter.SharesLevel getLevel() {
        return level;
    }
     ...
     * @param level
     */
    public void setLevel(com.vmware.converter.SharesLevel level) {
        this.level = level;
    }
