...
public class HostDatastoreBrowserSearchSpec  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.FileQuery[] query;

    private com.vmware.converter.FileQueryFlags details;
    ...
    public HostDatastoreBrowserSearchSpec(
           com.vmware.converter.FileQuery[] query,
           com.vmware.converter.FileQueryFlags details,
     ...
     * @return query
     */
    public com.vmware.converter.FileQuery[] getQuery() {
        return query;
    }
     ...
     * @param query
     */
    public void setQuery(com.vmware.converter.FileQuery[] query) {
        this.query = query;
    }

    public com.vmware.converter.FileQuery getQuery(int i) {
        return this.query[i];
    }

    public void setQuery(int i, com.vmware.converter.FileQuery _value) {
        this.query[i] = _value;
    }
     ...
     * @return details
     */
    public com.vmware.converter.FileQueryFlags getDetails() {
        return details;
    }
     ...
     * @param details
     */
    public void setDetails(com.vmware.converter.FileQueryFlags details) {
        this.details = details;
    }
