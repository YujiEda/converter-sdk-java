...
public class ArrayOfVirtualMachineLegacyNetworkSwitchInfo  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineLegacyNetworkSwitchInfo[] virtualMachineLegacyNetworkSwitchInfo;

    public ArrayOfVirtualMachineLegacyNetworkSwitchInfo() {
    }

    public ArrayOfVirtualMachineLegacyNetworkSwitchInfo(
           com.vmware.converter.VirtualMachineLegacyNetworkSwitchInfo[] virtualMachineLegacyNetworkSwitchInfo) {
     ...
     */
    public com.vmware.converter.VirtualMachineLegacyNetworkSwitchInfo[] getVirtualMachineLegacyNetworkSwitchInfo() {
        return virtualMachineLegacyNetworkSwitchInfo;
    }
     ...
     */
    public void setVirtualMachineLegacyNetworkSwitchInfo(com.vmware.converter.VirtualMachineLegacyNetworkSwitchInfo[] virtualMachineLegacyNetworkSwitchInfo) {
        this.virtualMachineLegacyNetworkSwitchInfo = virtualMachineLegacyNetworkSwitchInfo;
    }

    public com.vmware.converter.VirtualMachineLegacyNetworkSwitchInfo getVirtualMachineLegacyNetworkSwitchInfo(int i) {
        return this.virtualMachineLegacyNetworkSwitchInfo[i];
    }

    public void setVirtualMachineLegacyNetworkSwitchInfo(int i, com.vmware.converter.VirtualMachineLegacyNetworkSwitchInfo _value) {
