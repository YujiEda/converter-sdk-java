...
public class ArrayOfPropertySpec  implements java.io.Serializable {
    private com.vmware.converter.PropertySpec[] propertySpec;

    public ArrayOfPropertySpec() {
    }

    public ArrayOfPropertySpec(
           com.vmware.converter.PropertySpec[] propertySpec) {
     ...
     * @return propertySpec
     */
    public com.vmware.converter.PropertySpec[] getPropertySpec() {
        return propertySpec;
    }
     ...
     * @param propertySpec
     */
    public void setPropertySpec(com.vmware.converter.PropertySpec[] propertySpec) {
        this.propertySpec = propertySpec;
    }

    public com.vmware.converter.PropertySpec getPropertySpec(int i) {
        return this.propertySpec[i];
    }

    public void setPropertySpec(int i, com.vmware.converter.PropertySpec _value) {
