...
public class ArrayOfHostSystemResourceInfo  implements java.io.Serializable {
    private com.vmware.converter.HostSystemResourceInfo[] hostSystemResourceInfo;

    public ArrayOfHostSystemResourceInfo() {
    }

    public ArrayOfHostSystemResourceInfo(
           com.vmware.converter.HostSystemResourceInfo[] hostSystemResourceInfo) {
     ...
     */
    public com.vmware.converter.HostSystemResourceInfo[] getHostSystemResourceInfo() {
        return hostSystemResourceInfo;
    }
     ...
     */
    public void setHostSystemResourceInfo(com.vmware.converter.HostSystemResourceInfo[] hostSystemResourceInfo) {
        this.hostSystemResourceInfo = hostSystemResourceInfo;
    }

    public com.vmware.converter.HostSystemResourceInfo getHostSystemResourceInfo(int i) {
        return this.hostSystemResourceInfo[i];
    }

    public void setHostSystemResourceInfo(int i, com.vmware.converter.HostSystemResourceInfo _value) {
