...
public class DistributedVirtualSwitchHostMemberPnicBacking  extends com.vmware.converter.DistributedVirtualSwitchHostMemberBacking  implements java.io.Serializable {
    private com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] pnicSpec;

    public DistributedVirtualSwitchHostMemberPnicBacking() {
    }

    public DistributedVirtualSwitchHostMemberPnicBacking(
           com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] pnicSpec) {
     ...
     * @return pnicSpec
     */
    public com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] getPnicSpec() {
        return pnicSpec;
    }
     ...
     * @param pnicSpec
     */
    public void setPnicSpec(com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec[] pnicSpec) {
        this.pnicSpec = pnicSpec;
    }

    public com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec getPnicSpec(int i) {
        return this.pnicSpec[i];
    }

    public void setPnicSpec(int i, com.vmware.converter.DistributedVirtualSwitchHostMemberPnicSpec _value) {
