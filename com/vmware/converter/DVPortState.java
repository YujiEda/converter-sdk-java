...
public class DVPortState  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.DVPortStatus runtimeInfo;

    private com.vmware.converter.DistributedVirtualSwitchPortStatistics stats;

    private com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] vendorSpecificState;
    ...
    public DVPortState(
           ...
           com.vmware.converter.DistributedVirtualSwitchPortStatistics stats,
           com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] vendorSpecificState) {
     ...
     * @return stats
     */
    public com.vmware.converter.DistributedVirtualSwitchPortStatistics getStats() {
        return stats;
    }
     ...
     * @param stats
     */
    public void setStats(com.vmware.converter.DistributedVirtualSwitchPortStatistics stats) {
        this.stats = stats;
    }
     ...
     */
    public com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] getVendorSpecificState() {
        return vendorSpecificState;
    }
     ...
     */
    public void setVendorSpecificState(com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] vendorSpecificState) {
        this.vendorSpecificState = vendorSpecificState;
    }

    public com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob getVendorSpecificState(int i) {
        return this.vendorSpecificState[i];
    }

    public void setVendorSpecificState(int i, com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob _value) {
