...
public class ArrayOfHostVirtualNicConfig  implements java.io.Serializable {
    private com.vmware.converter.HostVirtualNicConfig[] hostVirtualNicConfig;

    public ArrayOfHostVirtualNicConfig() {
    }

    public ArrayOfHostVirtualNicConfig(
           com.vmware.converter.HostVirtualNicConfig[] hostVirtualNicConfig) {
     ...
     */
    public com.vmware.converter.HostVirtualNicConfig[] getHostVirtualNicConfig() {
        return hostVirtualNicConfig;
    }
     ...
     */
    public void setHostVirtualNicConfig(com.vmware.converter.HostVirtualNicConfig[] hostVirtualNicConfig) {
        this.hostVirtualNicConfig = hostVirtualNicConfig;
    }

    public com.vmware.converter.HostVirtualNicConfig getHostVirtualNicConfig(int i) {
        return this.hostVirtualNicConfig[i];
    }

    public void setHostVirtualNicConfig(int i, com.vmware.converter.HostVirtualNicConfig _value) {
