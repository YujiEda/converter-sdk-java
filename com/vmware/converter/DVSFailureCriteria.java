...
public class DVSFailureCriteria  extends com.vmware.converter.InheritablePolicy  implements java.io.Serializable {
    private com.vmware.converter.StringPolicy checkSpeed;

    private com.vmware.converter.IntPolicy speed;

    private com.vmware.converter.BoolPolicy checkDuplex;

    private com.vmware.converter.BoolPolicy fullDuplex;

    private com.vmware.converter.BoolPolicy checkErrorPercent;

    private com.vmware.converter.IntPolicy percentage;

    private com.vmware.converter.BoolPolicy checkBeacon;
    ...
    public DVSFailureCriteria(
           boolean inherited,
           com.vmware.converter.StringPolicy checkSpeed,
           com.vmware.converter.IntPolicy speed,
           com.vmware.converter.BoolPolicy checkDuplex,
           com.vmware.converter.BoolPolicy fullDuplex,
           com.vmware.converter.BoolPolicy checkErrorPercent,
           com.vmware.converter.IntPolicy percentage,
           com.vmware.converter.BoolPolicy checkBeacon) {
        super(
            inherited);
     ...
     * @return checkSpeed
     */
    public com.vmware.converter.StringPolicy getCheckSpeed() {
        return checkSpeed;
    }
     ...
     * @param checkSpeed
     */
    public void setCheckSpeed(com.vmware.converter.StringPolicy checkSpeed) {
        this.checkSpeed = checkSpeed;
    }
     ...
     * @return speed
     */
    public com.vmware.converter.IntPolicy getSpeed() {
        return speed;
    }
     ...
     * @param speed
     */
    public void setSpeed(com.vmware.converter.IntPolicy speed) {
        this.speed = speed;
    }
     ...
     * @return checkDuplex
     */
    public com.vmware.converter.BoolPolicy getCheckDuplex() {
        return checkDuplex;
    }
     ...
     * @param checkDuplex
     */
    public void setCheckDuplex(com.vmware.converter.BoolPolicy checkDuplex) {
        this.checkDuplex = checkDuplex;
    }
     ...
     * @return fullDuplex
     */
    public com.vmware.converter.BoolPolicy getFullDuplex() {
        return fullDuplex;
    }
     ...
     * @param fullDuplex
     */
    public void setFullDuplex(com.vmware.converter.BoolPolicy fullDuplex) {
        this.fullDuplex = fullDuplex;
    }
     ...
     */
    public com.vmware.converter.BoolPolicy getCheckErrorPercent() {
        return checkErrorPercent;
    }
     ...
     */
    public void setCheckErrorPercent(com.vmware.converter.BoolPolicy checkErrorPercent) {
        this.checkErrorPercent = checkErrorPercent;
    }
     ...
     * @return percentage
     */
    public com.vmware.converter.IntPolicy getPercentage() {
        return percentage;
    }
     ...
     * @param percentage
     */
    public void setPercentage(com.vmware.converter.IntPolicy percentage) {
        this.percentage = percentage;
    }
     ...
     * @return checkBeacon
     */
    public com.vmware.converter.BoolPolicy getCheckBeacon() {
        return checkBeacon;
    }
     ...
     * @param checkBeacon
     */
    public void setCheckBeacon(com.vmware.converter.BoolPolicy checkBeacon) {
        this.checkBeacon = checkBeacon;
    }
