...
public class DVSVendorSpecificConfig  extends com.vmware.converter.InheritablePolicy  implements java.io.Serializable {
    private com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] keyValue;
    ...
    public DVSVendorSpecificConfig(
           boolean inherited,
           com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] keyValue) {
        super(
            inherited);
     ...
     * @return keyValue
     */
    public com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] getKeyValue() {
        return keyValue;
    }
     ...
     * @param keyValue
     */
    public void setKeyValue(com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob[] keyValue) {
        this.keyValue = keyValue;
    }

    public com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob getKeyValue(int i) {
        return this.keyValue[i];
    }

    public void setKeyValue(int i, com.vmware.converter.DistributedVirtualSwitchKeyedOpaqueBlob _value) {
