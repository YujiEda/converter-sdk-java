...
public class ArrayOfHostInternetScsiHbaSendTarget  implements java.io.Serializable {
    private com.vmware.converter.HostInternetScsiHbaSendTarget[] hostInternetScsiHbaSendTarget;

    public ArrayOfHostInternetScsiHbaSendTarget() {
    }

    public ArrayOfHostInternetScsiHbaSendTarget(
           com.vmware.converter.HostInternetScsiHbaSendTarget[] hostInternetScsiHbaSendTarget) {
     ...
     */
    public com.vmware.converter.HostInternetScsiHbaSendTarget[] getHostInternetScsiHbaSendTarget() {
        return hostInternetScsiHbaSendTarget;
    }
     ...
     */
    public void setHostInternetScsiHbaSendTarget(com.vmware.converter.HostInternetScsiHbaSendTarget[] hostInternetScsiHbaSendTarget) {
        this.hostInternetScsiHbaSendTarget = hostInternetScsiHbaSendTarget;
    }

    public com.vmware.converter.HostInternetScsiHbaSendTarget getHostInternetScsiHbaSendTarget(int i) {
        return this.hostInternetScsiHbaSendTarget[i];
    }

    public void setHostInternetScsiHbaSendTarget(int i, com.vmware.converter.HostInternetScsiHbaSendTarget _value) {
