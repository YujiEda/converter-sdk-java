...
public class CustomizationSpecItem  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.CustomizationSpecInfo info;

    private com.vmware.converter.CustomizationSpec spec;

    public CustomizationSpecItem() {
    }

    public CustomizationSpecItem(
           com.vmware.converter.CustomizationSpecInfo info,
           com.vmware.converter.CustomizationSpec spec) {
        this.info = info;
        this.spec = spec;
    }
     ...
     * @return info
     */
    public com.vmware.converter.CustomizationSpecInfo getInfo() {
        return info;
    }
     ...
     * @param info
     */
    public void setInfo(com.vmware.converter.CustomizationSpecInfo info) {
        this.info = info;
    }
     ...
     * @return spec
     */
    public com.vmware.converter.CustomizationSpec getSpec() {
        return spec;
    }
     ...
     * @param spec
     */
    public void setSpec(com.vmware.converter.CustomizationSpec spec) {
        this.spec = spec;
    }
