...
public class PowerOnFtSecondaryFailed  extends com.vmware.converter.VmFaultToleranceIssue  implements java.io.Serializable {
    private com.vmware.converter.ManagedObjectReference vm;

    private java.lang.String vmName;

    private com.vmware.converter.FtIssuesOnHostHostSelectionType hostSelectionBy;

    private com.vmware.converter.LocalizedMethodFault[] hostErrors;

    private com.vmware.converter.LocalizedMethodFault rootCause;
    ...
    public PowerOnFtSecondaryFailed(
           ...
           com.vmware.converter.FtIssuesOnHostHostSelectionType hostSelectionBy,
           com.vmware.converter.LocalizedMethodFault[] hostErrors,
           com.vmware.converter.LocalizedMethodFault rootCause) {
        super(
            faultCause,
            faultMessage);
        this.vm = vm;
     ...
     */
    public com.vmware.converter.FtIssuesOnHostHostSelectionType getHostSelectionBy() {
        return hostSelectionBy;
    }
     ...
     */
    public void setHostSelectionBy(com.vmware.converter.FtIssuesOnHostHostSelectionType hostSelectionBy) {
        this.hostSelectionBy = hostSelectionBy;
    }
     ...
     * @return hostErrors
     */
    public com.vmware.converter.LocalizedMethodFault[] getHostErrors() {
        return hostErrors;
    }
     ...
     * @param hostErrors
     */
    public void setHostErrors(com.vmware.converter.LocalizedMethodFault[] hostErrors) {
        this.hostErrors = hostErrors;
    }

    public com.vmware.converter.LocalizedMethodFault getHostErrors(int i) {
        return this.hostErrors[i];
    }

    public void setHostErrors(int i, com.vmware.converter.LocalizedMethodFault _value) {
     ...
     * @return rootCause
     */
    public com.vmware.converter.LocalizedMethodFault getRootCause() {
        return rootCause;
    }
     ...
     * @param rootCause
     */
    public void setRootCause(com.vmware.converter.LocalizedMethodFault rootCause) {
        this.rootCause = rootCause;
    }
