...
public class HostInternetScsiHbaTargetSet  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.HostInternetScsiHbaStaticTarget[] staticTargets;

    private com.vmware.converter.HostInternetScsiHbaSendTarget[] sendTargets;

    public HostInternetScsiHbaTargetSet() {
    }

    public HostInternetScsiHbaTargetSet(
           com.vmware.converter.HostInternetScsiHbaStaticTarget[] staticTargets,
           com.vmware.converter.HostInternetScsiHbaSendTarget[] sendTargets) {
     ...
     */
    public com.vmware.converter.HostInternetScsiHbaStaticTarget[] getStaticTargets() {
        return staticTargets;
    }
     ...
     * @param staticTargets
     */
    public void setStaticTargets(com.vmware.converter.HostInternetScsiHbaStaticTarget[] staticTargets) {
        this.staticTargets = staticTargets;
    }

    public com.vmware.converter.HostInternetScsiHbaStaticTarget getStaticTargets(int i) {
        return this.staticTargets[i];
    }

    public void setStaticTargets(int i, com.vmware.converter.HostInternetScsiHbaStaticTarget _value) {
     ...
     * @return sendTargets
     */
    public com.vmware.converter.HostInternetScsiHbaSendTarget[] getSendTargets() {
        return sendTargets;
    }
     ...
     * @param sendTargets
     */
    public void setSendTargets(com.vmware.converter.HostInternetScsiHbaSendTarget[] sendTargets) {
        this.sendTargets = sendTargets;
    }

    public com.vmware.converter.HostInternetScsiHbaSendTarget getSendTargets(int i) {
        return this.sendTargets[i];
    }

    public void setSendTargets(int i, com.vmware.converter.HostInternetScsiHbaSendTarget _value) {
