...
public class ArrayOfVirtualMachineFileLayoutExDiskLayout  implements java.io.Serializable {
    private com.vmware.converter.VirtualMachineFileLayoutExDiskLayout[] virtualMachineFileLayoutExDiskLayout;

    public ArrayOfVirtualMachineFileLayoutExDiskLayout() {
    }

    public ArrayOfVirtualMachineFileLayoutExDiskLayout(
           com.vmware.converter.VirtualMachineFileLayoutExDiskLayout[] virtualMachineFileLayoutExDiskLayout) {
     ...
     */
    public com.vmware.converter.VirtualMachineFileLayoutExDiskLayout[] getVirtualMachineFileLayoutExDiskLayout() {
        return virtualMachineFileLayoutExDiskLayout;
    }
     ...
     */
    public void setVirtualMachineFileLayoutExDiskLayout(com.vmware.converter.VirtualMachineFileLayoutExDiskLayout[] virtualMachineFileLayoutExDiskLayout) {
        this.virtualMachineFileLayoutExDiskLayout = virtualMachineFileLayoutExDiskLayout;
    }

    public com.vmware.converter.VirtualMachineFileLayoutExDiskLayout getVirtualMachineFileLayoutExDiskLayout(int i) {
        return this.virtualMachineFileLayoutExDiskLayout[i];
    }

    public void setVirtualMachineFileLayoutExDiskLayout(int i, com.vmware.converter.VirtualMachineFileLayoutExDiskLayout _value) {
