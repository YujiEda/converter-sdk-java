...
public class PerformanceDescription  extends com.vmware.converter.DynamicData  implements java.io.Serializable {
    private com.vmware.converter.ElementDescription[] counterType;

    private com.vmware.converter.ElementDescription[] statsType;

    public PerformanceDescription() {
    }

    public PerformanceDescription(
           com.vmware.converter.ElementDescription[] counterType,
           com.vmware.converter.ElementDescription[] statsType) {
     ...
     * @return counterType
     */
    public com.vmware.converter.ElementDescription[] getCounterType() {
        return counterType;
    }
     ...
     * @param counterType
     */
    public void setCounterType(com.vmware.converter.ElementDescription[] counterType) {
        this.counterType = counterType;
    }

    public com.vmware.converter.ElementDescription getCounterType(int i) {
        return this.counterType[i];
    }

    public void setCounterType(int i, com.vmware.converter.ElementDescription _value) {
     ...
     * @return statsType
     */
    public com.vmware.converter.ElementDescription[] getStatsType() {
        return statsType;
    }
     ...
     * @param statsType
     */
    public void setStatsType(com.vmware.converter.ElementDescription[] statsType) {
        this.statsType = statsType;
    }

    public com.vmware.converter.ElementDescription getStatsType(int i) {
        return this.statsType[i];
    }

    public void setStatsType(int i, com.vmware.converter.ElementDescription _value) {
