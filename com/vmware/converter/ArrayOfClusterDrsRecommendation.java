...
public class ArrayOfClusterDrsRecommendation  implements java.io.Serializable {
    private com.vmware.converter.ClusterDrsRecommendation[] clusterDrsRecommendation;

    public ArrayOfClusterDrsRecommendation() {
    }

    public ArrayOfClusterDrsRecommendation(
           com.vmware.converter.ClusterDrsRecommendation[] clusterDrsRecommendation) {
     ...
     */
    public com.vmware.converter.ClusterDrsRecommendation[] getClusterDrsRecommendation() {
        return clusterDrsRecommendation;
    }
     ...
     */
    public void setClusterDrsRecommendation(com.vmware.converter.ClusterDrsRecommendation[] clusterDrsRecommendation) {
        this.clusterDrsRecommendation = clusterDrsRecommendation;
    }

    public com.vmware.converter.ClusterDrsRecommendation getClusterDrsRecommendation(int i) {
        return this.clusterDrsRecommendation[i];
    }

    public void setClusterDrsRecommendation(int i, com.vmware.converter.ClusterDrsRecommendation _value) {
