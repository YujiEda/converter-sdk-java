...
public class ArrayOfExtensionEventTypeInfo  implements java.io.Serializable {
    private com.vmware.converter.ExtensionEventTypeInfo[] extensionEventTypeInfo;

    public ArrayOfExtensionEventTypeInfo() {
    }

    public ArrayOfExtensionEventTypeInfo(
           com.vmware.converter.ExtensionEventTypeInfo[] extensionEventTypeInfo) {
     ...
     */
    public com.vmware.converter.ExtensionEventTypeInfo[] getExtensionEventTypeInfo() {
        return extensionEventTypeInfo;
    }
     ...
     */
    public void setExtensionEventTypeInfo(com.vmware.converter.ExtensionEventTypeInfo[] extensionEventTypeInfo) {
        this.extensionEventTypeInfo = extensionEventTypeInfo;
    }

    public com.vmware.converter.ExtensionEventTypeInfo getExtensionEventTypeInfo(int i) {
        return this.extensionEventTypeInfo[i];
    }

    public void setExtensionEventTypeInfo(int i, com.vmware.converter.ExtensionEventTypeInfo _value) {
