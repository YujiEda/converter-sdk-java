...
public class ArrayOfHostPciDevice  implements java.io.Serializable {
    private com.vmware.converter.HostPciDevice[] hostPciDevice;

    public ArrayOfHostPciDevice() {
    }

    public ArrayOfHostPciDevice(
           com.vmware.converter.HostPciDevice[] hostPciDevice) {
     ...
     */
    public com.vmware.converter.HostPciDevice[] getHostPciDevice() {
        return hostPciDevice;
    }
     ...
     * @param hostPciDevice
     */
    public void setHostPciDevice(com.vmware.converter.HostPciDevice[] hostPciDevice) {
        this.hostPciDevice = hostPciDevice;
    }

    public com.vmware.converter.HostPciDevice getHostPciDevice(int i) {
        return this.hostPciDevice[i];
    }

    public void setHostPciDevice(int i, com.vmware.converter.HostPciDevice _value) {
