...
public class ArrayOfPhysicalNicNameHint  implements java.io.Serializable {
    private com.vmware.converter.PhysicalNicNameHint[] physicalNicNameHint;

    public ArrayOfPhysicalNicNameHint() {
    }

    public ArrayOfPhysicalNicNameHint(
           com.vmware.converter.PhysicalNicNameHint[] physicalNicNameHint) {
     ...
     */
    public com.vmware.converter.PhysicalNicNameHint[] getPhysicalNicNameHint() {
        return physicalNicNameHint;
    }
     ...
     */
    public void setPhysicalNicNameHint(com.vmware.converter.PhysicalNicNameHint[] physicalNicNameHint) {
        this.physicalNicNameHint = physicalNicNameHint;
    }

    public com.vmware.converter.PhysicalNicNameHint getPhysicalNicNameHint(int i) {
        return this.physicalNicNameHint[i];
    }

    public void setPhysicalNicNameHint(int i, com.vmware.converter.PhysicalNicNameHint _value) {
