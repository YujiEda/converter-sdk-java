...
public class ArrayOfHostNumaNode  implements java.io.Serializable {
    private com.vmware.converter.HostNumaNode[] hostNumaNode;

    public ArrayOfHostNumaNode() {
    }

    public ArrayOfHostNumaNode(
           com.vmware.converter.HostNumaNode[] hostNumaNode) {
     ...
     * @return hostNumaNode
     */
    public com.vmware.converter.HostNumaNode[] getHostNumaNode() {
        return hostNumaNode;
    }
     ...
     * @param hostNumaNode
     */
    public void setHostNumaNode(com.vmware.converter.HostNumaNode[] hostNumaNode) {
        this.hostNumaNode = hostNumaNode;
    }

    public com.vmware.converter.HostNumaNode getHostNumaNode(int i) {
        return this.hostNumaNode[i];
    }

    public void setHostNumaNode(int i, com.vmware.converter.HostNumaNode _value) {
