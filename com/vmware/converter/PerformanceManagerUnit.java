...
public class PerformanceManagerUnit implements java.io.Serializable {
    ...
    public static final java.lang.String _teraBytes = "teraBytes";
    ...
    public static final PerformanceManagerUnit watt = new PerformanceManagerUnit(_watt);
    public static final PerformanceManagerUnit joule = new PerformanceManagerUnit(_joule);
    public static final PerformanceManagerUnit teraBytes = new PerformanceManagerUnit(_teraBytes);
